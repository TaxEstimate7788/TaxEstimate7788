        ...
        for (var i = 1; i <= 20; i++) {
            ...
            if (rightsideinputequation != "" && statusCheckbox == true) {
                ...
                if (parseInt(valuedropbox) <= 4) {
                    ...
                    if(document.getElementById('simulationmode').value == 'yes'){
                        npoints1 = 300;
                    };
                    var xh1 = (xRmax - xRmin) / npoints1;
                    //alert('555554 draw()')
...
//alert('gggggg.....'+rdata );        
 ...
 ////////////////////
     ...
     function draw() {
        ...
        for (var i = 1; i <= 20; i++) {
            ...
            if (ee1 != "" && ee2 && parseInt(valuedropbox) <= 4 ) {
                ...
                funGraph(ctx, "Y"+i, colorforgraph, 3, dataCX, dataCY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag,traparentlevel);
            ...
            //Draw graph with left side of equation containing "x"
                   ...
                   //alert('in draw()......222222');
                    ...
                    var colorforgraph = graphcolor(i);
                    funGraph(ctx, "X"+i, colorforgraph, 3, dataCX, dataCY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag,traparentlevel);
            ...
            //Draw graph with left side of equation containing "x squared" or "y-squared"
                    ...
                    var dataCY = dataB[1].split(",");
                    var colorforgraph = graphcolor(i);
                    funGraph(ctx, "X2"+i, colorforgraph, 3, dataCX, dataCY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag,traparentlevel);
            ...
            if (condition1 && condition2 && condition3) {
                ...
                var dashFlag = "0";
                funGraph(ctx, "Reflection", '#B8860B', 3, dataCX, dataCY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag,traparentlevel);
            ...
            if (condition1 && condition2 && condition3) {
                ...
                var dashFlag = "0";
                funGraph(ctx, "Rotation", '#B8860B', 3,  dataXrotation, dataYrotation, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag,traparentlevel);
                ctx.strokeStyle = colorforgraph;
            }
        ...
        //draw secant line
         if ((document.getElementById('secantlinedata').value).indexOf(';;;') > -1) {
             if (document.getElementById('showsecantline').checked) {
                 ...
                 var dataX = (dataSecant2[0]).split(';');
                 var dataY = (dataSecant2[1]).split(';');
                 //alert('dataX....' + dataX);
                 //alert('dataY....' + dataY); 
                 funGraph(ctx, "LIMIT", 'red', 3, dataX, dataY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag, '1');
                 ctx.globalAlpha = 1;
                 traparentlevel = 1;
             }
         }
        ...
        if ((document.getElementById('tangentlinedata').value).indexOf(';;;') > -1) {
            if (document.getElementById('showtangentline').checked) {
                ...
                funGraph(ctx, "LIMIT", 'green', 3, dataX, dataY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag, '1');
                ctx.globalAlpha = 1;
                traparentlevel = 1;
            }
        }
         ...
         var deltasymbol = String.fromCharCode(916);
         var Cplusdeltasymbol = 'x +'+String.fromCharCode(916)+'x';
                        ...
                        if (OpenClose) {
                            ...
                            if (i == 10) {
                                //add "delta y" label
                                    ...
                                    ctx.strokeStyle = 'blue';
                                    Label = Cplusdeltasymbol;
                                    ctx.font = "18px Georgia";
                                    var LocationX = xcoord;
                                    var LocationY = ycoord+20;
                                    ctx.fillStyle = 'green';
                                ...
                                //add "delta y" label
                                    ...
                                    ctx.arc(xcoord, ycoord, radius, 0, 2 * Math.PI, true);
                                    ctx.strokeStyle = 'blue';
                                    Label = '(x +'+ deltasymbol + 'x,'+'f(' + Cplusdeltasymbol + '))';
                                    ctx.font = "18px Georgia";
                                    var LocationX = xcoord ;
                                ...
                                if (document.getElementById('showdeltaXY').checked) {
                                    //draw delta x symbol
                                    var xt = (parseFloat(document.getElementById("Point13X").value) + parseFloat(document.getElementById("Point10X").value)) / 2;
                                    var yt = parseFloat(document.getElementById("Point13Y").value);
                                    ...
                                    //draw delta y symbol
                                    var xt = parseFloat(document.getElementById("Point12X").value);
                                    var yt = (parseFloat(document.getElementById("Point12Y").value) + parseFloat(document.getElementById("Point13Y").value)) / 2;
                                    var xcoord = x0 + xt * dxx;
                                    var ycoord = y0 - yt * dyy;
                                    ctx.beginPath();
                                    ctx.strokeStyle = 'red';
                                    //ctx.arc(xcoord, ycoord, radius, 0, 2 * Math.PI, true);
                                    ctx.strokeStyle = 'red';
                                    Label = deltasymbol + 'y=' + 'f(' + Cplusdeltasymbol + ') -f(x)';
                                    ctx.font = "18px Georgia";
                                    var LocationX = xcoord + 70;
                                    var LocationY = ycoord;
                                    ctx.fillStyle = 'red';
                                    ctx.fillText(Label, LocationX, LocationY);
                                    ctx.stroke();
                                    ctx.closePath();
                                    ...
                                    var dataXt = document.getElementById("Point13X").value + ';' + document.getElementById("Point10X").value; //+';'+ dataX3;
                                    var dataYt = document.getElementById("Point13Y").value + ';' + document.getElementById("Point13Y").value; //+';'+ dataY3;
                                    dataX = dataXt.split(';');
                                    dataY = dataYt.split(';');
                                    funGraph(ctx, "LIMIT", 'red', 3, dataX, dataY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag, '0.3');

                                    //draw vertical line for delta y
                                    var dataXt = document.getElementById("Point12X").value + ';' + document.getElementById("Point12X").value; //+';'+ dataX3;
                                    var dataYt = document.getElementById("Point12Y").value + ';' + document.getElementById("Point13Y").value; //+';'+ dataY3;
                                    dataX = dataXt.split(';');
                                    dataY = dataYt.split(';');
                                    funGraph(ctx, "LIMIT", 'red', 3, dataX, dataY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag, '0.3');
                                }
                                ...
                                if (document.getElementById('showdeltaXY').checked) {
                                    ...
                                    //draw horizontal line for delta x
                                    var dataXt = document.getElementById("Point16X").value +';'+ document.getElementById("Point17X").value;//+';'+ dataX3;
                                    var dataYt = document.getElementById("Point16Y").value +';'+ document.getElementById("Point17Y").value;//+';'+ dataY3;
                                    dataX = dataXt.split(';');
                                    dataY = dataYt.split(';'); 
                                    funGraph(ctx, "LIMIT", 'blue', 3,  dataX, dataY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag,'0.3');

                                    //draw vertical line for delta y
                                    var dataXt = document.getElementById("Point16X").value +';'+ document.getElementById("Point18X").value;//+';'+ dataX3;
                                    var dataYt = document.getElementById("Point16Y").value +';'+ document.getElementById("Point18Y").value;//+';'+ dataY3;
                                    dataX = dataXt.split(';');
                                    dataY = dataYt.split(';'); 
                                    funGraph(ctx, "LIMIT", 'blue', 3,  dataX, dataY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag,'0.3');
                                }
                                ...
                                var x17 = document.getElementById("Point17X").value;
                                var y17 = document.getElementById("Point17Y").value;
                                x17 = Math.round(x17*10000000000)/10000000000;
                                y17 = Math.round(y17*10000000000)/10000000000;
                                ctx.beginPath();
                                ctx.strokeStyle = 'blue';
                                ctx.arc(xcoord, ycoord, radius, 0, 2 * Math.PI, true);
                                ctx.strokeStyle = 'blue';
                                ...
                                var x17 = parseFloat(document.getElementById("Point17X").value);
                                var y17 = parseFloat(document.getElementById("Point17Y").value);
                                var x18 = parseFloat(document.getElementById("Point18X").value);
                                var y18 = parseFloat(document.getElementById("Point18Y").value);
                                var deltaX = Math.abs(x18 - x17);
                                deltaX = Math.round(deltaX*10000000000)/10000000000;
                                x17 = Math.round(x17*10000000000)/10000000000;
                                y17 = Math.round(y17*10000000000)/10000000000;
                                x18 = Math.round(x18*10000000000)/10000000000;
                                y18 = Math.round(y18*10000000000)/10000000000;
                                var slopeSecant = (y18 - y17) / (x18 - x17);
                                slopeSecant = Math.round(slopeSecant*10000000000)/10000000000;
                                ctx.beginPath();
                                ctx.strokeStyle = 'red';
                                ctx.arc(xcoord, ycoord, radius, 0, 2 * Math.PI, true);
                                ctx.strokeStyle = 'red';
                                ctx.font = "30px Georgia";
                                Label = '(' + x18  + ' , ' + y18  + ')' ;//'(' + Cplusdeltasymbol + ',' + 'f(' + Cplusdeltasymbol + '))';
                                var LocationX = xcoord + 10;
                                var LocationY = ycoord - 10;
                                ctx.fillStyle = 'green';
                                ctx.fillText(Label, LocationX, LocationY);
                                ctx.stroke();
                                ...
                                ctx.fillStyle = 'blue';
                                Label = deltasymbol + 'x = ' + document.getElementById("deltaX").value;
                                ctx.fillText(Label, 270, 475);
                                Label = 'slope of secant line = ' + slopeSecant;
                                ctx.fillText(Label, 270, 515);
        ...
        if(document.getElementById("checkboxcircle").checked){
            for (var i = 1; i <= 10; i++) {
                ...
                if (pcc1 != "" && pcc2 != "" && pcc3 != "" && pcc4) {
                    ...
                    var dashFlag = "0";
                    var colorforgraph = graphcolor(i);
                    funGraph(ctx, "c1", colorforgraph, 3, data3X, data3Y, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, '0',traparentlevel);
        ...
        if (document.getElementById("ParametricEquationsOnOff").checked) {
            for (var i = 1; i <= 10; i++) {
                ...
                if (tt1 != "" && tt2 != "" && tt3) {
                    ...
                    var dashFlag = "0";
                    var colorforgraph = graphcolor(i);
                    funGraph(ctx, "X1Y1", colorforgraph, 3, data3X, data3Y, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, '0',traparentlevel);
                }
            }
        }
        ...
        if (document.getElementById("PolarEquationsOnOff").checked) {
            for (var i = 1; i <= 20; i++) {
                ...
                if (document.getElementById("PolarEquation"+i).value != "" && pp) {
                    ...
                    var dashFlag = "0";
                    var colorforgraph = graphcolor(i);
                    funGraph(ctx, "r1", colorforgraph, 3, data3X, data3Y, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, '0',traparentlevel);
                }
    ...
    function funGraph(ctx, func, color, thick, dataX, dataY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashedFlag, shadeflag,traparentlevel) {

        ctx.beginPath();
        ctx.lineWidth = thick;
        ctx.strokeStyle = color;
        ctx.globalAlpha = traparentlevel; //transparency level
...
function insertAtCaret(element, text, val1, val2, val3, val4) {
   ...
   function Textboxongrid22BB(casenum) {
    ...
    function Example41(){
        document.getElementById('LimitFunction').value = '0.3x²+2';
        document.getElementById('limitvalue').value = '1';
        document.getElementById('deltaX2').value = '4';
    ...
    function Example42(){
        document.getElementById('LimitFunction').value = '0.1x³+2';
        document.getElementById('limitvalue').value = '2';
        document.getElementById('deltaX2').value = '3';
        document.getElementById('xMinParameter').value = '-10';
        document.getElementById('xMaxParameter').value = 20;
        document.getElementById('yMinParameter').value = '-10';
        document.getElementById('yMaxParameter').value = 20;
    ...
    function Example43(){
        document.getElementById('LimitFunction').value = ' √ ̅(4x+2)';
        document.getElementById('limitvalue').value = '2';
        document.getElementById('deltaX2').value = '10';
        document.getElementById('xMinParameter').value = '-10';
        document.getElementById('xMaxParameter').value = 20;
        document.getElementById('yMinParameter').value = '-10';
        document.getElementById('yMaxParameter').value = 20;
    ...
    function Example44(){
        document.getElementById('LimitFunction').value = 'Sin(x)';
        document.getElementById('limitvalue').value = '4.6';
        document.getElementById('deltaX2').value = '3';
        document.getElementById('xMinParameter').value = '-10';
        document.getElementById('xMaxParameter').value = 20;
        document.getElementById('yMinParameter').value = '-10';
    ...
    function Example46(){
        document.getElementById('LimitFunction2').value = '0.1x²+1';
        document.getElementById('limitvalue').value = '1';
        document.getElementById('deltaX').value = '6';
    ...
    function Example47(){
        document.getElementById('LimitFunction2').value = '0.3x²+1';
        document.getElementById('limitvalue').value = '2';
        document.getElementById('deltaX').value = '4.6';
        document.getElementById('deltaXincrement').value='0.1';
        document.getElementById('xMinParameter').value = '-10';
        document.getElementById('xMaxParameter').value = 20;
        document.getElementById('yMinParameter').value = '-10';
    ...
    function Example50(){
        ...
        document.getElementById('limitvalue').value = '2';
        document.getElementById('deltaX').value = '3';
        document.getElementById('deltaXincrement').value='0.1';
        document.getElementById('xMinParameter').value = '-10';
        document.getElementById('xMaxParameter').value = 20;
        document.getElementById('yMinParameter').value = '-10';
    ...
    function AutomaticSimulation(){
        stopmessage = 'continue';
        var stepsize = 0.1;
        var deltaX = parseFloat(document.getElementById('deltaX').value);    
        var count = 0;
        var myVarTangentLine = setInterval(function () {
            count += 1;
            if (deltaX <= 0.1 && deltaX > 0.01) {
                stepsize = 0.01;
            }
            else if (deltaX <= 0.01 && deltaX > 0.001) {
                stepsize = 0.001;
            }
            else if (deltaX <= 0.001 && deltaX > 0.0001) {
                stepsize = 0.0001;
            }
            else if (deltaX <= 0.0001 && deltaX > 0.00001) {
                stepsize = 0.00001;
            }
            else if (deltaX <= 0.00001 && deltaX > 0.000001) {
                stepsize = 0.000001;
            }
            else if (deltaX <= 0.000001 && deltaX > 0.0000001) {
                stepsize = 0.0000001;
            }
            else if (deltaX <= 0.0000001 && deltaX > 0.00000001) {
                stepsize = 0.00000001;
            }
            deltaX = parseFloat(deltaX) - parseFloat(stepsize);
            if (deltaX <= 0) {
                deltaX = 0.00000001;
                stopmessage == 'stop';
            }
            ...
            document.getElementById('deltaX').value = ToDecimal2(deltaX.toString());

            //if ((document.getElementById('deltaX').value).indexOf('e') > -1) {
            //    document.getElementById('deltaX').value = (document.getElementById('deltaX').value).toFixed(10);
            //}

            deltachange('3');


            if (count > 1000 || stopmessage == 'stop') {
                clearInterval(myVarTangentLine);
            }
    ...
    function myVarTangentLineClear(){
        stopmessage = 'stop';
        //alert('kkkkkrrrrrrr.......'+stopmessage);
        //clearInterval(myVarTangentLine);
    }
    ...
    function deltachange(casenum) {
        //ClearGraphs();
        //clearcartesianpoint();        
        var Cvalue = document.getElementById('limitvalue2').value;
        var stepsize = document.getElementById('deltaXincrement').value;
        var deltaX = document.getElementById('deltaX').value;
        var  CplusDeltaX = parseFloat(Cvalue) + parseFloat(deltaX);


        if (casenum == '1') {//manual simulation process
            deltaX = parseFloat(deltaX) + parseFloat(stepsize);
            var  CplusDeltaX = parseFloat(Cvalue) + parseFloat(deltaX);
            if (parseFloat(deltaX) < 0.0001) { deltaX = 0.001; }
            document.getElementById('deltaX').value =  Math.round(deltaX * 1000000000000) / 1000000000000;
        }
        else if (casenum == '2') {//manual simulation process
            deltaX = parseFloat(deltaX) - parseFloat(stepsize);
            if (parseFloat(deltaX) < 0.0001) { deltaX = 0.001; }
            var  CplusDeltaX = parseFloat(Cvalue) + parseFloat(deltaX);
            document.getElementById('deltaX').value =  Math.round(deltaX * 1000000000000) / 1000000000000;
        ...
        else if (casenum == '3') {//automatic simulation process
            //deltaX = parseFloat((deltaX).toFixed(10));
            //CplusDeltaX = parseFloat((CplusDeltaX.toString).toFixed(10));
        }
        

        document.getElementById('Point19X').value = Cvalue;
        document.getElementById('Point19Y').value = 0;
        
        document.getElementById('Point20X').value = CplusDeltaX;
        document.getElementById('Point20Y').value = 0;
        ...
        //(c+dx, f(c+dx)
        var x2 =  CplusDeltaX;
        var temp1 = replaceAll(InputExpression, "x", "(" + x2.toString() + ")");
        var y2 = FindValue(temp1);
        y2 = Math.round(y2 * 1000000000000) / 1000000000000;
        document.getElementById('Point18X').value = x2;
        document.getElementById('Point18Y').value = y2;



        //(c, f(c))
        var x1 = Cvalue;
        var temp1 = replaceAll(InputExpression, "x", "(" + x1.toString() + ")");
        var y1 = FindValue(temp1);
        y1 = Math.round(y1 * 1000000000000) / 1000000000000;
        document.getElementById('Point17X').value = x1;
        document.getElementById('Point17Y').value = y1;
        document.getElementById('Point16X').value = CplusDeltaX;
        document.getElementById('Point16Y').value = y1;
        //location of delta x
        document.getElementById('Point15X').value = (parseFloat(CplusDeltaX) + parseFloat(Cvalue))/2;
        document.getElementById('Point15Y').value = y1;

        //location of delta y
        document.getElementById('Point14X').value = CplusDeltaX;
        document.getElementById('Point14Y').value = (parseFloat(y2) + parseFloat(y1))/2;


        //(x3, f(x3))
        var x3 = parseFloat(Cvalue) + 0.01;
        var temp1 = replaceAll(InputExpression, "x", "(" + x3.toString() + ")");
        var y3 = FindValue(temp1);
        y3 = Math.round(y3 * 1000000000000) / 1000000000000;
        
        var slopesecantline = (parseFloat(y2) - parseFloat(y1)) / (parseFloat(x2) - parseFloat(x1));
        var slopetangentline = (parseFloat(y3) - parseFloat(y1)) / (parseFloat(x3) - parseFloat(x1));

        var equationsecantline = slopesecantline + '(x - (' + x1 + ')) + (' + y1 +')';
        var equationtangentline = slopetangentline + '(x - (' + x1 + ')) + (' + y1 +')';
        ...
        CplusDeltaX = Math.round(CplusDeltaX * 10000000000) / 10000000000;
        dy = Math.round(dy * 10000000000) / 10000000000;
        slopesecantline = Math.round(slopesecantline * 10000000000) / 10000000000;
        document.getElementById('TableDataLimitY1D').innerHTML = '<br><br>x = ' + x1 + '<br>';
        document.getElementById('TableDataLimitY1D').innerHTML += 'f(x) =' + y1+ '<br>';

        document.getElementById('TableDataLimitY1D').innerHTML += 'x +' + deltasymbol + 'x = ' + CplusDeltaX + '<br>';
        document.getElementById('TableDataLimitY1D').innerHTML += 'f(x +' + deltasymbol + 'x) = ' + y2+ '<br>';
        document.getElementById('TableDataLimitY1D').innerHTML += deltasymbol + 'y = ' + 'f(x+' + deltasymbol + 'x) - ' + 'f(x) = ' + dy+ '<br><br>';
        var text = 'Slope of secant line = ' + deltasymbol + 'y/' + deltasymbol + 'x = ' + slopesecantline+ '<br><br>';

        
        document.getElementById('TableDataLimitY1D').innerHTML += '<br>' + '<img src="ABGraphingCalculatorTangentV2bbimage01.png" alt="001111" />' + '<span style="position:relative; top:-33px"> ' + slopesecantline + '</span>' + '<br><br>';




        var text22 = '<br><br>Note: As '+deltasymbol+'x approaches 0, the secant line approaches the tangent line. ';
        document.getElementById('TableDataLimitY1D').innerHTML += text22;
        var text22 = '<br>Hence, slope of the secant line approaches the slope of tangent line.<br><br>';
        document.getElementById('TableDataLimitY1D').innerHTML += text22;
    ...
    function findtangentline() {
        //ClearGraphs();              
        document.getElementById('simulationmode').value = 'no'; 
        //clearcartesianpoint();
        //alert('kkkkkk');
        var Cvalue = document.getElementById('limitvalue').value;
        //var stepsize = document.getElementById('deltaXincrement').value;
        var deltaX = document.getElementById('deltaX2').value;
        var deltasymbol = String.fromCharCode(916);
        ...
        var limval = 0;// document.getElementById('limitvalue').value;
        ...
        document.getElementById('leftsidelimit').innerHTML = 'Limit from the left: ' + deltasymbol + 'x approaches 0 from the left.';
        document.getElementById('rightsidelimit').innerHTML = 'Limit from the right: ' + deltasymbol + 'x approaches 0 from the right.';


        var deltasymbol = String.fromCharCode(916);
        var deltaXsymbol = String.fromCharCode(916)+'x';
        var deltaYsymbol = String.fromCharCode(916)+'y';
        var diffquot = deltaYsymbol + '/' + deltaXsymbol;

        //find f(c) 
        var temp1 = replaceAll(InputExpression, "x", "(" + Cvalue.toString() + ")");
        var fc = FindValue(temp1);
        if (IsNumericc(fc) == false || fc == null) {
            fc = NaN;
        }
        fc = Math.round(fc * 100000000000000) / 100000000000000;
        fc = ToDecimal2(fc.toString());
        ...
        if(isNaN(fc) == false){
            document.getElementById('Point11X').value = Cvalue;
            document.getElementById('Point11Y').value = 0;
            document.getElementById('checkboxCartesianPoints').checked = true;
            document.getElementById("pointsizeS").checked = true;
        }
        ...
        var text = "y = " + document.getElementById('TextBoxForCartesianGraph20').value + "<br><br>";
        text = '<span style="font-size:20px; color: blue">' + text + '</span>';
        ...
        //Draw secant line and tangent line
        ...
        var y2 = FindValue(temp1);
        y2 = Math.round(y2 * 1000000000000) / 1000000000000;
        document.getElementById('Point12X').value = x2;
        document.getElementById('Point12Y').value = y2;
        document.getElementById('Point10X').value = CplusDeltaX;
        document.getElementById('Point10Y').value = 0;
        ...
        var y1 = FindValue(temp1);
        y1 = Math.round(y1 * 1000000000000) / 1000000000000;
        document.getElementById('Point13X').value = x1;
        ...
        var text12 = 'c = ' + Cvalue + ' <br> f(c) = ' + fc+'<br>';
        document.getElementById('TableDataLimitY1C').innerHTML = text12;
        
        var text22 = deltasymbol+'x = 3  (arbitrary initial value of ' + deltasymbol+'x)<br>';
        var text22 =text22+ 'c+'+ deltasymbol+'x = '+CplusDeltaX+'<br>';
        document.getElementById('TableDataLimitY1C').innerHTML += text22;
        var text22 = 'f(c+'+ deltasymbol+'x) = '+y2+'<br>';
        document.getElementById('TableDataLimitY1C').innerHTML += text22;
        var text22 = deltasymbol+'y = ' +'f(c+'+ deltasymbol+'x) - f(c) = '+(y2-y1)+'<br>';
        document.getElementById('TableDataLimitY1C').innerHTML += text22;
        var text22 = 'Slope of Secant Line = '+deltasymbol+'y/'+ deltasymbol+'x = '+((y2-y1)/parseFloat(deltaX))+'<br><br>';
        document.getElementById('TableDataLimitY1C').innerHTML += text22;

        var text22 = 'Slope of tangent line depends on the limit of ('+ deltasymbol+'y/'+ deltasymbol+'x) as '+deltasymbol+'x approaches 0.<br><br>';
        document.getElementById('TableDataLimitY1C').innerHTML += text22;

        var text22 = 'As '+deltasymbol+'x approaches 0, the secant line approaches the tangent line. ';
        document.getElementById('TableDataLimitY1C').innerHTML += text22;
        var text22 = 'Hence, the slope of secant line approaches the slope of tangent line.<br><br>';
        document.getElementById('TableDataLimitY1C').innerHTML += text22;

        var text11 = 'In the tables below, the ' + diffquot + ' column represents the '
           + 'slope of the secant line (aqua line on grid). '
           + 'To see if the limit of ' + diffquot + ' exists as ' + deltaXsymbol + ' approaches 0, '
           + 'we can examine the values in last column of each table to see if the limit from the left '
           + 'and the limit from the right are the same or not. '
           + 'If the limit of ' + diffquot + ' exists as ' + deltaXsymbol + ' approaches 0 '
           + 'then value of this limit is the slope of the tangent line (purple line on grid).';           
             
        document.getElementById('TableDataLimitY1C').innerHTML += text11;
        ...
        if (parseFloat(limval) == 0) {            
            ...
            for (var i = 1; i <= 11; i++) {
                ...
                var x = '-0.' + xb + '1';
                var dx = x;
                var CplusDeltaX = parseFloat(Cvalue) + parseFloat(dx);
                var temp1 = replaceAll(InputExpression, "x", "(" + CplusDeltaX + ")");
                var fCDelta = FindValue(temp1);

                if (isFinite(fCDelta) == false) {
                    fCDelta = 'Very Large Number';
                }

                var dy = parseFloat(fCDelta) - parseFloat(fc);
                var diffquot = parseFloat(dy) / parseFloat(dx);

                data1 += ';' + dx;//delta x
                data2 += ';' + fCDelta; //f(c + dx)
                data3 += ';' + dy;//f(c + dx) - f(c)
                data4 += ';' + diffquot;//  dy/dx
                data5 += ';' + CplusDeltaX; //c+ dx
            }
            ...
            tableCreateLimit(data1, data2, data3, data4, data5, colorTable, TableName,RightSideEquation,fc);
        ...
        //Writing equations for secant line and tangent line.
        text =  "Equation in Point-Slope Form: y - y<sub>1</sub> = m(x - x<sub>1</sub>); <br>"
             +  "where m = slope and (x<sub>1</sub>, y<sub>1</sub>) is a point on the line.<br><br>";
        document.getElementById('TableDataLimitY1E').innerHTML = text;
        
        text = 'For the secant line:<br>'
             + 'm = slope = ' + slopesecantline + '<br>'
             + '(x<sub>1</sub>, y<sub>1</sub>) = ' + '('+ x1 + ' , ' + y1  + ')' + '<br><br>'
             + 'Equation of Secant Line: <br>';
        document.getElementById('TableDataLimitY1E').innerHTML += text;
        document.getElementById('x1y1').value = x1 + ';' + y1;
        text = writelinearequation(slopesecantline, x1, y1)
        document.getElementById('TableDataLimitY1E').innerHTML += text;

        var inputbox1 = '<input type="text" id = "slope33"  value="" style="height: 20px; width: 100px; background-color:  beige" onclick="currentID()"/>';
        var inputbox2 = '<input type="button" value= "Submit" class="submit" style="height: 30px; width: 100px;  background-color: #ffd800" onclick="findtangentline88()"/>';

        text = '<br><br><br>For the tangent line:<br>'
             + '(x<sub>1</sub>, y<sub>1</sub>) = ' + '(' + x1 + ' , ' + y1 + ')' + '<br>'
             + 'Input: m = slope = ' + inputbox1 + ' ' + inputbox2 
             + '<br><br>';
    ...
    function tableCreateLimit(data1, data2, data3, data4, data5,color,TableName,RightSideEquation,fc) {        
        var deltasymbol = String.fromCharCode(916);
        var deltaXsymbol = String.fromCharCode(916)+'x';
        var deltaYsymbol = String.fromCharCode(916)+'y';
        var diffquotsymbol = deltaYsymbol+'/'+deltaXsymbol;
        var cplusdeltaXsymbol = 'c+'+ String.fromCharCode(916)+'x';
        var FcplusdeltaXsymbol = 'f(c+'+ String.fromCharCode(916)+'x)';
        ...
        var xval = data1.split(';'); //dx
        var wwval = data5.split(';'); //c+dx
        var yval = data2.split(';'); //f(c+dx)
        var zval = data3.split(';'); //dy
        var wval = data4.split(';'); //dy/dx
        ...
        td.style.color = color;
        td.style.borderColor = color;
        td.appendChild(document.createTextNode(deltaXsymbol));

        var td = tr.insertCell();
        td.style.border = "solid";
        td.style.color = color;
        td.style.borderColor = color;
        td.appendChild(document.createTextNode(cplusdeltaXsymbol));

        var td = tr.insertCell();
        td.style.border = "solid";
        td.style.color = color;
        td.style.borderColor = color;
        td.appendChild(document.createTextNode(FcplusdeltaXsymbol));

        var td = tr.insertCell();
        td.style.border = "solid";
        td.style.color = color;
        td.style.borderColor = color;
        td.appendChild(document.createTextNode('f(c)'));
        ...
        td.style.color = color;
        td.style.borderColor = color;
        td.appendChild(document.createTextNode(deltaYsymbol));

        var td = tr.insertCell();
        td.style.border = "solid";
        td.style.color = color;
        td.style.borderColor = color;
        td.appendChild(document.createTextNode(diffquotsymbol));
        ...
        for (var i = 0; i < xval.length; i++) {
            ...
            td.style.color = "black";
            td.style.borderWidth = '1px';
            td.appendChild(document.createTextNode(wwval[i]));
            ...
            td.style.color = "black";
            td.style.borderWidth = '1px';
            td.appendChild(document.createTextNode(fc));
            ...
            td.style.color = "black";
            td.style.borderWidth = '1px';
            td.appendChild(document.createTextNode(wval[i]));
...
/*------------------------------------------------------------------------------
* NAME       :  handleEventKeyboard2
* PURPOSE    :  Displays keypad
* PARAMETERS :  
* RETURNS    :  
*----------------------------------------------------------------------------*/   
    function handleEventKeyboard2(num){
        if (num == '3') {
            document.getElementById('panel2').style.display = 'inline-block';
            document.getElementById('panel2').style.top = '350px';
            document.getElementById('panel2').style.left = '600px';
        }
        else if (num == '4') {
            document.getElementById('panel2').style.display = 'inline-block';
            document.getElementById('panel2').style.top = '350px';
