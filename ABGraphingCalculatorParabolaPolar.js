...
//alert('gggggg.....'+rdata );        
 ...
 ////////////////////
   ...
   function findIVT() {
        ...
        var dir = document.getElementById('directrix').value;
        ...
        var tt = document.getElementById('directrix').value;
        var tt2 = tt.split('=');

        
        if (tt.indexOf('x') > -1) {//case 3:  directrix is vertical (x = c) and focus is right
            document.getElementById('mydropdownCartesian1').value = 5;
            document.getElementById('TextBoxForCartesianGraph1').value = tt2[1];

            var dd = parseFloat(FindValue(tt2[1]));
            if (dd < 0) {
                var rr = '((' + eccen + ')(' + (-1 * dd) + '))/(1 - (' + eccen + ')(cos(θ)))';
                document.getElementById('typeofDirectrix').value = '1'; //vertical directrix to the left of pole
            }
            else if (dd > 0) {
                var rr = '((' + eccen + ')(' + dd + '))/(1 + (' + eccen + ')(cos(θ)))';
                document.getElementById('typeofDirectrix').value = '2'; //vertical directrix to the right of pole
            }
            ...
            document.getElementById("PolarEquation2").value = rr;
            var xArray = [];
            var xtt = [];
            var yArray = [];

            if (document.getElementById('typeofDirectrix').value == '1') {
                //xArray[1] = 0; yArray[1] = FindValue(rr.replace('θ', '(' + xArray[1] + ')')); alert(xArray[1]+'.....'+yArray[1]);
                xArray[1] = Math.PI / 6; yArray[1] = FindValue(rr.replace('θ', '(' + xArray[1] + ')')); //alert(xArray[2]+'...2..'+yArray[2]);
                xArray[2] = Math.PI / 3; yArray[2] = FindValue(rr.replace('θ', '(' + xArray[2] + ')')); //alert(xArray[3]+'...3..'+yArray[3]);
                xArray[3] = Math.PI / 2; yArray[3] = FindValue(rr.replace('θ', '(' + xArray[3] + ')')); //alert(xArray[3]+'...3..'+yArray[3]);
                xArray[4] = 2 * Math.PI / 3; yArray[4] = FindValue(rr.replace('θ', '(' + xArray[4] + ')')); //alert(xArray[4]+'...4..'+yArray[4]);
                xArray[5] = 5 * Math.PI / 6; yArray[5] = FindValue(rr.replace('θ', '(' + xArray[5] + ')')); //alert(xArray[5]+'...5..'+yArray[5]);
                xArray[6] = Math.PI; yArray[6] = FindValue(rr.replace('θ', '(' + xArray[6] + ')')); //alert(xArray[6]+'...6..'+yArray[6]);
                xArray[7] = 7 * Math.PI / 6; yArray[7] = FindValue(rr.replace('θ', '(' + xArray[7] + ')'));
                xArray[8] = 4 * Math.PI / 3; yArray[8] = FindValue(rr.replace('θ', '(' + xArray[8] + ')'));
                xArray[9] = 3 * Math.PI / 2; yArray[9] = FindValue(rr.replace('θ', '(' + xArray[9] + ')'));
                xArray[10] = 5 * Math.PI / 3; yArray[10] = FindValue(rr.replace('θ', '(' + xArray[10] + ')'));
                xArray[11] = 11 * Math.PI / 6; yArray[11] = FindValue(rr.replace('θ', '(' + xArray[11] + ')'));
                //xArray[12] =2*Math.PI; yArray[12] = FindValue(rr.replace('θ', '(' + xArray[12] + ')'));

                //xtt[1] = 0; 
                xtt[1] = '&pi;/6'; xtt[2] = '&pi;/3'; xtt[3] = '&pi;/2';
                xtt[4] = '2&pi;/3'; xtt[5] = '5&pi;/6'; xtt[6] = '&pi;'; xtt[7] = '7&pi;/6';
                xtt[8] = '4&pi;/3'; xtt[9] = '3&pi;/2'; xtt[10] = '5&pi;/3'; xtt[11] = '11&pi;/6';

            }
            if (document.getElementById('typeofDirectrix').value == '2') {

                xArray[1] = 0; yArray[1] = FindValue(rr.replace('θ', '(' + xArray[1] + ')')); //alert(xArray[1]+'.....'+yArray[1]);
                xArray[2] = Math.PI / 6; yArray[2] = FindValue(rr.replace('θ', '(' + xArray[2] + ')')); //alert(xArray[2]+'...2..'+yArray[2]);
                xArray[3] = Math.PI / 3; yArray[3] = FindValue(rr.replace('θ', '(' + xArray[3] + ')')); //alert(xArray[3]+'...3..'+yArray[3]);
                xArray[4] = Math.PI / 2; yArray[4] = FindValue(rr.replace('θ', '(' + xArray[4] + ')')); //alert(xArray[3]+'...3..'+yArray[3]);
                xArray[5] = 2 * Math.PI / 3; yArray[5] = FindValue(rr.replace('θ', '(' + xArray[5] + ')')); //alert(xArray[4]+'...4..'+yArray[4]);
                xArray[6] = 5 * Math.PI / 6; yArray[6] = FindValue(rr.replace('θ', '(' + xArray[6] + ')')); //alert(xArray[5]+'...5..'+yArray[5]);
                //xArray[7] = Math.PI; yArray[7] = FindValue(rr.replace('θ', '(' + xArray[7] + ')')); //alert(xArray[6]+'...6..'+yArray[6]);
                xArray[7] = 7 * Math.PI / 6; yArray[7] = FindValue(rr.replace('θ', '(' + xArray[7] + ')'));
                xArray[8] = 4 * Math.PI / 3; yArray[8] = FindValue(rr.replace('θ', '(' + xArray[8] + ')'));
                xArray[9] = 3 * Math.PI / 2; yArray[9] = FindValue(rr.replace('θ', '(' + xArray[9] + ')'));
                xArray[10] = 5 * Math.PI / 3; yArray[10] = FindValue(rr.replace('θ', '(' + xArray[10] + ')'));
                ...
                xtt[1] = 0; xtt[2] = '&pi;/6'; xtt[3] = '&pi;/3'; xtt[4] = '&pi;/2';
                xtt[5] = '2&pi;/3'; xtt[6] = '5&pi;/6'; 
                //xtt[7] = '&pi;'; 
                xtt[7] = '7&pi;/6';
                xtt[8] = '4&pi;/3'; xtt[9] = '3&pi;/2'; xtt[10] = '5&pi;/3'; xtt[11] = '11&pi;/6';
            ...
            for (var i = 1; i <= 11; i++) {
                var xxt = parseFloat(yArray[i])*Math.cos(xArray[i]);
                var yyt = parseFloat(yArray[i])*Math.sin(xArray[i]);
                document.getElementById('Point' + (i + 1) + 'X').value = xxt;
                document.getElementById('Point' + (i + 1) + 'Y').value = yyt;
                ...
                var thetar = Math.round(xArray[i] * 1000000000000) / 1000000000000;
                var rrr = Math.round(yArray[i] * 1000000000000) / 1000000000000;
                var xxt = Math.round(xxt * 1000000000000) / 1000000000000;
                var yyt = Math.round(yyt * 1000000000000) / 1000000000000;

                var dd1 = Math.sqrt(xxt*xxt + yyt*yyt);
                var dd2 = Math.abs(dd - xxt);
 
                 var colorforgraph = graphcolor(i+1);
                var text =  '<span style="color: '+colorforgraph+';font-size:30px"></span>'  +'For the polar point '+lettersArray[i-1]+'(r, θ) = (' + rrr + ',' + xtt[i] + '):<br>'
                   + 'Note: Corresponding '+lettersArray[i-1]+'(x, y) = '+lettersArray[i-1]+'(' +  + xxt + ',' + yyt + '):<br>'
                   + 'd<sub><sub>1</sub></sub> = Distance from (' + xxt + ',' + yyt + ') to Focus (0, 0) = ' + dd1 + '<br>'
                   + 'd<sub><sub>2</sub></sub> = Distance from (' + xxt + ',' + yyt + ') to directrix = ' + dd2 + '<br>'
                   + '<i>e</i> = d<sub><sub>1</sub></sub> / d<sub><sub>2</sub></sub> = ' + dd1 + ' / ' + dd2 + ' = ' + eccen + '<br><br><br>'
                    ;
                document.getElementById('TableDataLimitY1C').innerHTML +='<span style="font-size:22px">' + text + '</span>';
            }
        ...
        else if (tt.indexOf('y') > -1) {//directrix is above or below pole
            document.getElementById('mydropdownCartesian1').value = 0;
            document.getElementById('TextBoxForCartesianGraph1').value = tt2[1];

            var dd = parseFloat(FindValue(tt2[1]));
            if (dd < 0) {
                var rr = '((' + eccen + ')(' + (-1 * dd) + '))/(1 - (' + eccen + ')(sin(θ)))';
                document.getElementById('typeofDirectrix').value = '3'; //horizontal directrix below pole
            }
            else if (dd > 0) {
                var rr = '((' + eccen + ')(' + dd + '))/(1 + (' + eccen + ')(sin(θ)))';
                document.getElementById('typeofDirectrix').value = '4'; //horizontal directrix above pole
            }
            ...
            if(document.getElementById('typeofDirectrix').value == '3'){
                var tth = '0' + ';' + Math.PI/6 +';'+Math.PI/3 +';'+2*Math.PI/3 +';'+5*Math.PI/6
                         +';'+ Math.PI+';'+7*Math.PI/6 +';'+ 4*Math.PI/3+';'+3*Math.PI/2 +';'+5*Math.PI/3 +';'+11*Math.PI/6;
               
                var ttw = '0' + ';' + 'π/6' +';' + 'π/3' + ';' + '2π/3' + ';' + '5π/6'
                         +';'+ 'π'+';'+'7π/6' +';'+ '4π/3'+';'+'3π/2' +';'+ '5π/3' +';'+ '11π/6';


            };

            if(document.getElementById('typeofDirectrix').value == '4'){
                var tth =  '0' + ';' + Math.PI/6 + ';' + Math.PI/3 + ';' + Math.PI/2 + ';' + 2*Math.PI/3 + ';'+5*Math.PI/6
                         + ';' + Math.PI + ';' + 7*Math.PI/6 + ';' + 4*Math.PI/3 + ';' + 5*Math.PI/3 + ';' + 11*Math.PI/6;

                var ttw = '0' + ';' + 'π/6' +';'+'π/3' +'π/2'+';'+'2π/3' +';'+ '5π/6'
                         +';'+ 'π'+';'+'7π/6' +';'+ '4π/3'+';' + '5π/3' +';'+ '11π/6';

            };


            var xArray = tth.split(';');
            var xtt = ttw.split(';');
            var yArray = [];


            yArray[0] = FindValue(rr.replace('θ', '(' + xArray[0] + ')'));//alert(xArray[1]+'.....'+yArray[1]);
            yArray[1] = FindValue(rr.replace('θ', '(' + xArray[1] + ')'));//alert(xArray[2]+'...2..'+yArray[2]);
            yArray[2] = FindValue(rr.replace('θ', '(' + xArray[2] + ')'));//alert(xArray[3]+'...3..'+yArray[3]);
            yArray[3] = FindValue(rr.replace('θ', '(' + xArray[3] + ')'));//alert(xArray[3]+'...3..'+yArray[3]);
            yArray[4] = FindValue(rr.replace('θ', '(' + xArray[4] + ')'));//alert(xArray[4]+'...4..'+yArray[4]);
            yArray[5] = FindValue(rr.replace('θ', '(' + xArray[5] + ')'));//alert(xArray[5]+'...5..'+yArray[5]);
            yArray[6] = FindValue(rr.replace('θ', '(' + xArray[6] + ')'));//alert(xArray[6]+'...6..'+yArray[6]);
            yArray[7] = FindValue(rr.replace('θ', '(' + xArray[7] + ')'));
            yArray[8] = FindValue(rr.replace('θ', '(' + xArray[8] + ')'));
            yArray[9] = FindValue(rr.replace('θ', '(' + xArray[9] + ')'));
            yArray[10] = FindValue(rr.replace('θ', '(' + xArray[10] + ')'));
            //alert('xArray....' + xArray);
            //alert('yArray....' + yArray);
            ...
            for (var i = 0; i <= 10; i++) {
                var xxt = parseFloat(yArray[i])*Math.cos(xArray[i]);
                var yyt = parseFloat(yArray[i])*Math.sin(xArray[i]);
                document.getElementById('Point' + (i + 2) + 'X').value = xxt;
                document.getElementById('Point' + (i + 2) + 'Y').value = yyt;
 
                //alert('xxt=' + xxt + '/////yyt = ' + yyt);
                var thetar = Math.round(xArray[i] * 1000000000000) / 1000000000000;
                var rrr = Math.round(yArray[i] * 1000000000000) / 1000000000000;
                var xxt = Math.round(xxt * 1000000000000) / 1000000000000;
                var yyt = Math.round(yyt * 1000000000000) / 1000000000000;
                ...
                var dd1 = Math.sqrt(xxt*xxt + yyt*yyt);
                //var dd2 = Math.sqrt((dd - xxt)*(dd - xxt) +  yyt*yyt);
                var dd2 = Math.abs(dd - yyt);

                var colorforgraph = graphcolor(i+1);
                var text =  '<span style="color: '+colorforgraph+';font-size:30px"></span>'  +'For the polar point '+lettersArray[i-1]+'(r, θ) = (' + rrr + ',' + xtt[i] + '):<br>'
                   + 'Note: Corresponding '+lettersArray[i-1]+'(x, y) = (' +  + xxt + ',' + yyt + '):<br>'
                   + 'd<sub><sub>1</sub></sub> = Distance from (' + xxt + ',' + yyt + ') to Focus (0, 0) = ' + dd1 + '<br>'
                   + 'd<sub><sub>2</sub></sub> = Distance from (' + xxt + ',' + yyt + ') to directrix = ' + dd2 + '<br>'
                   + '<i>e</i> = d<sub><sub>1</sub></sub> / d<sub><sub>2</sub></sub> = ' + dd1 + ' / ' + dd2 + ' = ' + eccen + '<br><br><br>'
                    ;
   ...
   function findPolarConic() {
        ...
        if (tt.indexOf('x') > -1) {//case 3:  directrix is vertical (x = c) and focus is right
            ...
            //alert('rr=' + rr);
            document.getElementById("PolarEquationsOnOff").checked = true;
            document.getElementById("checkboxPolarEquation2").checked = true;
            document.getElementById("PolarTmin").value = 0;
            document.getElementById("PolarTmax").value = 6.28;
            document.getElementById("PolarTstepsize").value = 0.1;
            document.getElementById("PolarEquation2").value = rr;
            var xArray = [];
            var xtt = [];
        ...
        clearcartesianpoint();
        document.getElementById("Point1X").value = '0';
...
function insertAtCaret(element, text, val1, val2, val3, val4) {
   ...
   function Textboxongrid22BB(casenum) {
    ...
    function Example1ivt(){
        ...
        document.getElementById('LimitFunction').value = '1';
    ...
    function Example2ivt(){
     ...
     function Example5ivt(){
        //alert('7777');
        document.getElementById('LimitFunction').value = 'Cos(x) + Sin(x)';
        document.getElementById('LimitFunction2').value = '-Sin(x) + Cos(x)';
        document.getElementById('Avalue').value = '0';
        document.getElementById('Bvalue').value = 'π';
