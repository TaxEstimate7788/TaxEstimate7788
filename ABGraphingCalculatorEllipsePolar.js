...
//alert('gggggg.....'+rdata );        
 ...
 ////////////////////
   ...
   function findIVT() {
        ...
        var dir = document.getElementById('DirectrixEquation').value;
        ...
        if(parseFloat(eccen) >= 1){
            alert('For ellipse, eccentricity must be less than 1.');
            return;
        }

        var tt = document.getElementById('DirectrixEquation').value;
        var tt2 = tt.split('=');
        ...
        if (tt.indexOf('x') > -1) {//case 3:  directrix is vertical (x = c) and focus is right
            ...
            document.getElementById("PolarEquation1").value = rr;
            var xArray = [];
            var xtt = [];
            var yArray = [];
            //alert("Please input function f '(x).");
            ...
            xArray[8] = 7*Math.PI/6;   yArray[8] = FindValue(rr.replace('θ', '(' + xArray[8] + ')'));
            xArray[9] = 4*Math.PI/3;   yArray[9] = FindValue(rr.replace('θ', '(' + xArray[9] + ')'));
            xArray[10] = 3*Math.PI/2;  yArray[10] = FindValue(rr.replace('θ', '(' + xArray[10] + ')'));
            xArray[11] = 5*Math.PI/3;  yArray[11] = FindValue(rr.replace('θ', '(' + xArray[11] + ')'));
            xArray[12] = 11*Math.PI/6; yArray[12] = FindValue(rr.replace('θ', '(' + xArray[12] + ')'));
            //xArray[12] =2*Math.PI; yArray[12] = FindValue(rr.replace('θ', '(' + xArray[12] + ')'));

            xtt[1] = 0;xtt[2] = '&pi;/6';xtt[3] = '&pi;/3';xtt[4] = '&pi;/2';
            xtt[5] = '2&pi;/3';xtt[6] = '5&pi;/6';xtt[7] = '&pi;';xtt[8] = '7&pi;/6';
            xtt[9] = '4&pi;/3';xtt[10] = '3&pi;/2';xtt[11] = '5&pi;/3';xtt[12] = '11&pi;/6';
            //alert("Please input function f '(x).555555");
            for (var i = 1; i <= 12; i++) {
            ...
            //alert("Please input function f '(x).44444444444444");
...
function insertAtCaret(element, text, val1, val2, val3, val4) {
   ...
   function Textboxongrid22BB(casenum) {
    ...
    function Example1ivt(){
        document.getElementById('DirectrixEquation').value = 'x = -8';
        document.getElementById('LimitFunction').value = '0.6';
    ...
    function Example2ivt(){
     ...
     function Example3ivt(){
        document.getElementById('DirectrixEquation').value = 'y = -8';
        document.getElementById('LimitFunction').value = '0.6';
        document.getElementById('Avalue').value = '0';
        document.getElementById('Bvalue').value = '0';
        document.getElementById('Cvalue').value = '0';
