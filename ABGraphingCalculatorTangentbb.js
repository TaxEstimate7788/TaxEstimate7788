...
//alert('gggggg.....'+rdata );        
    ...
    function currentID() {
        ...
        getCursorPosition(selected, window.event);
    }
     ...
     function draw() {
        ...
        if ((document.getElementById('tangentlinedata').value).indexOf(';;;') > -1) {
            if (document.getElementById('showtangentline').checked) {
                ...
                funGraph(ctx, "LIMIT", 'green', 3, dataX, dataY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag, '3');
                ctx.globalAlpha = 1;
                traparentlevel = 1;
            }
        }
         ...
         var Xplusdeltasymbol = 'x+'+String.fromCharCode(916)+'x';
                        ...
                        if (OpenClose) {
                            ...
                            if (i == 10) {
                                ...
                                //add "delta y" label
                                    ...
                                    ctx.arc(xcoord, ycoord, radius, 0, 2 * Math.PI, true);
                                    ctx.strokeStyle = 'blue';
                                    Label = '(x+'+ deltasymbol + 'x,'+'f(' + Xplusdeltasymbol + '))';
                                    ctx.font = "18px Georgia";
                                    var LocationX = xcoord ;
                                ...
                                if (document.getElementById('showdeltaXY').checked) {
                                    ...
                                    //ctx.arc(xcoord, ycoord, radius, 0, 2 * Math.PI, true);
                                    ctx.strokeStyle = 'red';
                                    Label = deltasymbol + 'y=' + 'f(' + Xplusdeltasymbol + ') -f(x)';
                                    ctx.font = "18px Georgia";
                                ...
                                ctx.strokeStyle = 'red';
                                ctx.font = "18px Georgia";
                                Label = '(' + Xplusdeltasymbol + ',' + 'f(' + Xplusdeltasymbol + '))';
...
function insertAtCaret(element, text, val1, val2, val3, val4) {
   ...
   function Textboxongrid22BB(casenum) {
    ...
    function Example44(){
        document.getElementById('LimitFunction').value = 'Cos(x)';
    ...
    function Example46(){
        ...
        document.getElementById('limitvalue2').value = '2';
    ...
    function Example48(){
        ...
        function Example49(){
        document.getElementById('LimitFunction2').value = 'Cos(x)';
        document.getElementById('limitvalue2').value = '2';
        document.getElementById('deltaX').value = '4.6';
        document.getElementById('deltaXincrement').value='0.1';
        document.getElementById('xMinParameter').value = '-10';
    ...
    function deltachange(casenum) {
        document.getElementById('simulationmode').value = 'yes';
        //clearcartesianpoint();
        //ClearGraphs();
        ...
        //var  XplusDeltaX = parseFloat(Cvalue) + parseFloat(deltaX);
        if (casenum == '1') {
        ...
        document.getElementById('Point20X').value = XplusDeltaX;
        ...
        document.getElementById('Point16X').value = XplusDeltaX;
        document.getElementById('Point16Y').value = y1;
        //location of delta x
        document.getElementById('Point15X').value = (parseFloat(XplusDeltaX) + parseFloat(Cvalue))/2;
        document.getElementById('Point15Y').value = y1;

        //location of delta y
        document.getElementById('Point14X').value = XplusDeltaX;
        ...
        XplusDeltaX = Math.round(XplusDeltaX * 10000000000) / 10000000000;
        dy = Math.round(dy * 10000000000) / 10000000000;
        slopesecantline = Math.round(slopesecantline * 10000000000) / 10000000000;
        document.getElementById('TableDataLimitY1D').innerHTML = 'x = ' +Cvalue + '<br>' +'x+' + deltasymbol + 'x = ' + XplusDeltaX + '<br>';
        ...
        document.getElementById('TableDataLimitY1D').innerHTML += deltasymbol + 'y = ' + 'f(x+' + deltasymbol + 'x) - ' + 'f(x) = ' + dy+ '<br>';
        ...
        var singlequote = String.fromCharCode(180);//accent grave
        var text = 'Note: f '+singlequote+'('+Cvalue+') = Slope of Tangent Line (purple line)';  
        document.getElementById('TableDataLimitY1D').innerHTML += text;
    ...
    function findtangentline() {
        ...
        var fx = FindValue(temp1);
        if (IsNumericc(fx) == false || fx == null) {
            fx = NaN;
        }
        fx = Math.round(fx * 100000000000000) / 100000000000000;
        fx = ToDecimal2(fx.toString());
        ...
        document.getElementById('Point10X').value = XplusDeltaX;
        ...
        var text12 = 'x = ' + Cvalue + ' <br> f(x) = ' + fx+'<br>';
        document.getElementById('TableDataLimitY1C').innerHTML = text12;


        var text22 = deltasymbol+'x =' + deltaX + '  (arbitrary initial value of ' + deltasymbol+'x)<br>';
        var text22 =text22+ 'x+'+ deltasymbol+'x = '+XplusDeltaX+'<br>';
        document.getElementById('TableDataLimitY1C').innerHTML += text22;
        var text22 = 'f(x+'+ deltasymbol+'x) = '+y2+'<br>';
        document.getElementById('TableDataLimitY1C').innerHTML += text22;
        var text22 = deltasymbol+'y = ' +'f(x+'+ deltasymbol+'x) - f(x) = '+(y2-y1)+'<br>';
        document.getElementById('TableDataLimitY1C').innerHTML += text22;
        var text22 = 'Slope of Secant Line = '+deltasymbol+'y/'+ deltasymbol+'x = '+((y2-y1)/parseFloat(deltaX))+'<br><br>';
        document.getElementById('TableDataLimitY1C').innerHTML += text22;

        var text22 = 'Slope of tangent line depends on the <br>limit of ('+ deltasymbol+'y/'+ deltasymbol+'x) as '+deltasymbol+'x approaches 0.<br><br>';
        document.getElementById('TableDataLimitY1C').innerHTML += text22;


        var text11 = 'In the tables below, the ' + diffquot + ' column represents the <br>'
           + 'slope of the secant line (aqua line on grid).<br>'
           + 'To see if the limit of ' + diffquot + ' exists as ' + deltaXsymbol + ' approaches 0, <br>'
           + 'we can examine the values in last column of each table. <br>'
           + 'If the limit of ' + diffquot + ' exists as ' + deltaXsymbol + ' approaches 0 <br>'
           + 'then value of this limit is the slope of the <br>tangent line (purple line on grid).';           
        ...
        if (parseFloat(limval) == 0) {            
            ...
            for (var i = 1; i <= 11; i++) {
                ...
                var x = '-0.' + xb + '1';
                var dx = x;
                var XplusDeltaX = parseFloat(Cvalue) + parseFloat(dx);
                var temp1 = replaceAll(InputExpression, "x", "(" + XplusDeltaX + ")");
                ...
                var dy = parseFloat(fCDelta) - parseFloat(fx);
                var diffquot = parseFloat(dy) / parseFloat(dx);

                data1 += ';' + dx;//delta x
                data2 += ';' + fCDelta; //f(x + dx)
                data3 += ';' + dy;//f(x + dx) - f(x)
                data4 += ';' + diffquot;//  dy/dx
                data5 += ';' + XplusDeltaX; //x+ dx
            }
            ...
            tableCreateLimit(data1, data2, data3, data4, data5, colorTable, TableName,RightSideEquation,fx);
    ...
    function GraphEpsDel() {
        ...
        var text = '(c - ' + deltasymbol + ', x + ' + deltasymbol + ') = (' + CminusDel + ' , '+ CplusDel+')<br><br>';
        ...
        document.getElementById('TableDataLimitY1').innerHTML += 'f(x - ' + deltasymbol + ') = ' + y1 + '<br><br>';
        document.getElementById('TableDataLimitY1').innerHTML += 'f(x + ' + deltasymbol + ') = ' + y2 + '<br><br>';
    ...
    function tableCreateLimit(data1, data2, data3, data4, data5,color,TableName,RightSideEquation,fx) {        
        var deltasymbol = String.fromCharCode(916);
        var deltaXsymbol = String.fromCharCode(916)+'x';
        var deltaYsymbol = String.fromCharCode(916)+'y';
        var diffquotsymbol = deltaYsymbol+'/'+deltaXsymbol;
        var XplusDeltaXsymbol = 'x+'+ String.fromCharCode(916)+'x';
        var FXplusDeltaXsymbol = 'f(x+'+ String.fromCharCode(916)+'x)';
        ...
        var wwval = data5.split(';'); //x+dx
        var yval = data2.split(';'); //f(x+dx)
        ...
        td.style.color = color;
        td.style.borderColor = color;
        td.appendChild(document.createTextNode(XplusDeltaXsymbol));

        var td = tr.insertCell();
        td.style.border = "solid";
        td.style.color = color;
        td.style.borderColor = color;
        td.appendChild(document.createTextNode(FXplusDeltaXsymbol));

        var td = tr.insertCell();
        td.style.border = "solid";
        td.style.color = color;
        td.style.borderColor = color;
        td.appendChild(document.createTextNode('f(x)'));
