                    ...
                    if (coordX != "" && coordY != "" && PlotStatus) {
                        ...
                        if (OpenClose) {
                            ...
                            if (i == 1) {
                                ...
                                ctx.font="20px Georgia";
                                Label = 'V1';
                                ctx.fillText(Label, xcoord+25 , ycoord + 25);
                                ctx.stroke();
                                ctx.closePath();
                            }
                            else if (i == 4) {
    ...
    function funPlotPoint(ctx, func, color, thick, dataX, dataY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashedFlag, shadeflag,transparencylevel) {
        ...
        var setLineDashError = false;
           ...
           ctx.closePath();
            ...
            //alert('parseFloat(dataX) = ' + parseFloat(dataX) + '...........parseFloat(dataY) = ' + parseFloat(dataX));
           return;
...
function insertAtCaret(element, text, val1, val2, val3, val4) {
   ...
   function Textboxongrid22BB(casenum) {
    ...
    function Example1ivt(){
        document.getElementById('LimitFunction').value = '24';
        document.getElementById('Avalue').value = '10';
        document.getElementById('Bvalue').value = '0';
        document.getElementById('Cvalue').value = '-10';
    ...
    function Example2ivt(){
        document.getElementById('LimitFunction').value = '20';
        document.getElementById('Avalue').value = '8';
        document.getElementById('Bvalue').value = '0';
     ...
     function Example3ivt(){
        ...
        document.getElementById('Bvalue').value = '10';
        document.getElementById('Cvalue').value = '0';
        document.getElementById('Dvalue').value = '-10';
        document.getElementById('NumberOfSegments').value = '0';
        findIVT();
    }   
     function Example4ivt(){
        document.getElementById('LimitFunction').value = '24';
        document.getElementById('Avalue').value = '0';
        document.getElementById('Bvalue').value = '8';
        document.getElementById('Cvalue').value = '0';
        document.getElementById('Dvalue').value = '-8';
        document.getElementById('NumberOfSegments').value = '0';
        findIVT();
    }   
     ...
     function Example5ivt(){
        document.getElementById('LimitFunction').value = '24';
        document.getElementById('Avalue').value = '0';
        document.getElementById('Bvalue').value = '6';
        document.getElementById('Cvalue').value = '0';
        document.getElementById('Dvalue').value = '-6';
...
//alert('222');
        ...
        if (parseFloat(Bvalue) == parseFloat(Dvalue)) {//case 1:  horizontal ellipse
            ...
            var ftn11 = '('+bb+')(1-(x-' + '(' + hh + ')' + ')^2/'+aa2+')^(1/2) + ' + kk;
            var ftn22 = '-('+bb+')(1-(x-' + '(' + hh + ')' + ')^2/'+aa2+')^(1/2) + ' + kk;
//alert("xArray + ......... + xArray");
            GraphingCalculator();
            var xArray = [];
            var yArray = [];
            ...
            xArray[1] = hh - 3*stepsize; yArray[1] = FindValue(ftn11.replace('x', '(' + xArray[1] + ')'));//alert(xArray[1]+'...1..'+yArray[1]);
            xArray[2] = hh - 3*stepsize; yArray[2] = FindValue(ftn22.replace('x', '(' + xArray[2] + ')'));//alert(xArray[2]+'...2..'+yArray[2]);
            xArray[3] = hh - 2*stepsize; yArray[3] = FindValue(ftn11.replace('x', '(' + xArray[3] + ')'));//alert(xArray[3]+'...3..'+yArray[3]);
            xArray[4] = hh - 2*stepsize; yArray[4] = FindValue(ftn22.replace('x', '(' + xArray[4] + ')'));//alert(xArray[4]+'...4..'+yArray[4]);
            xArray[5] = hh - 1*stepsize; yArray[5] = FindValue(ftn11.replace('x', '(' + xArray[5] + ')'));//alert(xArray[5]+'...5..'+yArray[5]);
            xArray[6] = hh - 1*stepsize; yArray[6] = FindValue(ftn22.replace('x', '(' + xArray[6] + ')'));//alert(xArray[6]+'...6..'+yArray[6]);

            xArray[7] = hh + 1*stepsize; yArray[7] = FindValue(ftn11.replace('x', '(' + xArray[7] + ')'));
            xArray[8] = hh + 1*stepsize; yArray[8] = FindValue(ftn22.replace('x', '(' + xArray[8] + ')'));
            xArray[9] = hh + 2*stepsize; yArray[9] = FindValue(ftn11.replace('x', '(' + xArray[9] + ')'));
            xArray[10] = hh + 2*stepsize; yArray[10] = FindValue(ftn22.replace('x', '(' + xArray[10] + ')'));
            xArray[11] = hh + 3*stepsize; yArray[11] = FindValue(ftn11.replace('x', '(' + xArray[11] + ')'));
            xArray[12] = hh + 3*stepsize; yArray[12] = FindValue(ftn22.replace('x', '(' + xArray[12] + ')'));
...
//alert(xArray + "........." + yArray);
            ...
            document.getElementById('TableDataLimitY1C').innerHTML += 'Note: a<sup>2</sup> = b<sup>2</sup> + c<sup>2</sup><br>';
            document.getElementById('TableDataLimitY1C').innerHTML += 'Note: b<sup>2</sup> = a<sup>2</sup> - c<sup>2</sup><br><br><br>';
        ...
        else if (parseFloat(Avalue) == parseFloat(Cvalue)) {//case 2:  vertical ellipse
        ...
        if (document.getElementById('pointsonparabola').value == 'case1') {
            document.getElementById('TableDataLimitY1C').innerHTML += '<img src="ellipse2a.png" alt="blank" /><br><br>';
            document.getElementById('TableDataLimitY1C').innerHTML += '<img src="ellipse2b.png" alt="blank" />';
        }
        else if (document.getElementById('pointsonparabola').value == 'case2') {
            document.getElementById('TableDataLimitY1C').innerHTML += '<img src="ellipse2c.png" alt="blank" />';
        }
       return;
