 ...
 ////////////////////
     ...
     function draw() {
        ...
        if ((document.getElementById('tangentlinedata').value).indexOf(';;;') > -1) {
         ...
         var Cplusdeltasymbol = 'c+'+String.fromCharCode(916)+'x';
                        ...
                        if (OpenClose) {
                            ...
                            if (i == 10) {
                                ...
                                //add "delta y" label
                                    ...
                                    ctx.arc(xcoord, ycoord, radius, 0, 2 * Math.PI, true);
                                    ctx.strokeStyle = 'blue';
                                    Label = '(c+'+ deltasymbol + 'x,'+'f(' + Cplusdeltasymbol + '))';
                                    ctx.font = "18px Georgia";
                                    var LocationX = xcoord ;
                                ...
                                if (document.getElementById('showdeltaXY').checked) {
                                    ...
                                    //ctx.arc(xcoord, ycoord, radius, 0, 2 * Math.PI, true);
                                    ctx.strokeStyle = 'red';
                                    Label = deltasymbol + 'y=' + 'f(' + Cplusdeltasymbol + ') -f(c)';
                                    ctx.font = "18px Georgia";
                                ...
                                ctx.strokeStyle = 'red';
                                ctx.font = "18px Georgia";
                                Label = '(' + Cplusdeltasymbol + ',' + 'f(' + Cplusdeltasymbol + '))';
...
function insertAtCaret(element, text, val1, val2, val3, val4) {
   ...
   function Textboxongrid22BB(casenum) {
    ...
    function deltachange(casenum) {
        ...
        document.getElementById('TextBoxForCartesianGraph20').value = document.getElementById('LimitFunction2').value;
        while (InputExpression.indexOf("nroot") > -1) {
            InputExpression = processnroot(InputExpression);
        }
        InputExpression = replaceAll(InputExpression, 'NRRR', 'NROOT');
        ...
        document.getElementById('TableDataLimitY1D').innerHTML = 'c+' + deltasymbol + 'x = ' + CplusDeltaX + '<br>';
        document.getElementById('TableDataLimitY1D').innerHTML += 'f(c+' + deltasymbol + 'x) = ' + y2+ '<br>';
        document.getElementById('TableDataLimitY1D').innerHTML += 'f(c) =' + y1+ '<br>';
        document.getElementById('TableDataLimitY1D').innerHTML += deltasymbol + 'y = ' + 'f(c+' + deltasymbol + 'x) - ' + 'f(c) = ' + dy+ '<br><br>';
        ...
        var text22 = 'Note: As '+deltasymbol+'x approaches 0, the secant line approaches the tangent line. ';
        document.getElementById('TableDataLimitY1D').innerHTML += text22;
        var text22 = 'Hence, slope of the secant line approaches the slope of tangent line.<br><br>';
        document.getElementById('TableDataLimitY1D').innerHTML += text22;
