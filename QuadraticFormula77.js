...
function zoomtype(val){
    if(val == 0){
        document.getElementById("viewport").setAttribute('content','maximum-scale=1.0; user-scalable=0;');
        document.getElementById("disablezoom0").checked = true;
        document.getElementById("disablezoom2").checked = true;
    }
    else{
        document.getElementById("viewport").setAttribute('content','maximum-scale=4.0; user-scalable=1;');
        document.getElementById("disablezoom1").checked = true;
        document.getElementById("disablezoom3").checked = true;
    }
}
...
/*------------------------------------------------------------------------------
 * NAME       : NDeriv
 * PURPOSE    : Find numerical derivative of function f(x) at c
 * PARAMETERS : c and f(x)
 * RETURNS    : numerical derivative f'(c)
 *----------------------------------------------------------------------------*/
...
/*------------------------------------------------------------------------------
 * NAME       : ProcessInput
 * PURPOSE    : Processes input string to make it possible for conversion to Polish notation
...
*----------------------------------------------------------------------------*/
    function IsFunction(func) {
        ...
        var ListFuncOps = ["AVG", "ABS", "ACOS", "ASC", "ASIN", "ATAN", "COS", "FIX",
...
/*------------------------------------------------------------------------------
* NAME       :  SIMPLIFY22
* PURPOSE    :  Simplifies square root expression
* PARAMETERS :  square root expression
* RETURNS    :  simplified square root expression
*----------------------------------------------------------------------------*/
    function SIMPLIFY22(s) {
        if (s != parseInt(s)) {
            var text = '&#8730<span style="text-decoration: overline">' + s + '</span> ';
            return text;
        }

        var letter = String.fromCharCode(960);
        var letter2 = String.fromCharCode(178);     //sup 2
        var letter3 = String.fromCharCode(179);     //sup 3
        var letter4 = String.fromCharCode(8308);    //sup 4
        var letter5 = String.fromCharCode(8309);    //sup 5
        var letter6 = String.fromCharCode(8310);    //sup 6
        var letter7 = String.fromCharCode(8311);    //sup 7
        var letter8 = String.fromCharCode(8211);    //n dash
        var letter9 = String.fromCharCode(8730);    //square root
        var letter10 = String.fromCharCode(8731);   //cube root
        var letter11 = String.fromCharCode(8732);   //4th root
        var letter12 = String.fromCharCode(773);    //overline (on top of a character)

        var AA = String.fromCharCode(8730);  //root 2 
        var BB = String.fromCharCode(160);   //space   
        var CC = String.fromCharCode(773);   //overline
        var A = (AA).toString();
        var B = (BB).toString();
        var C = (CC).toString();
        var SQRT = A + B + C;
        ...
        if (s == parseInt(s) && s > 0) {
            ...
            if (n1 == 1 && n2 == 1) {
                ...
                var result = '&#8730<span style="text-decoration: overline">' + n2 + '</span>';
                ...
                var text = '&#8730<span style="text-decoration: overline">(' + n1 * n1 + ")(" + n2 + ')</span> = ';
                var result = n1 + '&#8730<span style="text-decoration: overline">' + n2 + '</span>';
            }

        }
        else if (s == parseInt(s) && s < 0) {
            //case 2: s is a negative 
            n1 = 1;
            n2 = 1;
            ...
            if (s == parseInt(s) && s < 0) {
                ...
                if (n1 == 1 && n2 == 1) {
                    ...
                    var result = 'i&#8730<span style="text-decoration: overline">' + n2 + '</span>';
                }
                else if (n1 != 1 && n2 == 1) {
                    var result = n1 + "i";
                    ...
                    var text = '&#8730<span style="text-decoration: overline">(-1)(' + n1 * n1 + ")(" + n2 + ')</span> = ';
                    var result = n1 + 'i&#8730<span style="text-decoration: overline">' + n2 + '</span>';
...
* RETURNS    :  simplified square root expression
*----------------------------------------------------------------------------*/
    function SIMPLIFY22B(s) {
        if (s != parseInt(s)) {
            var text = '&#8730<span style="text-decoration: overline">' + s + '</span> ';
            var text = '<span class="radical">&radic;</span><span class="radicand">' + s + '</span>';
        ...
        if (s == parseInt(s) && s > 0) {
            ...
            if (n1 == 1 && n2 == 1) {
                ...
                var result = '&#8730<span style="text-decoration: overline">' + n2 + '</span>';
                var result = '<span class="radical">&radic;</span><span class="radicand">' + n2 + '</span>';
                ...
                var text = '&#8730<span style="text-decoration: overline">(' + n1 * n1 + ")(" + n2 + ')</span> = ';
                var result = n1 + '&#8730<span style="text-decoration: overline">' + n2 + '</span>';
                var result = n1 + '<span class="radical">&radic;</span><span class="radicand">' + n2 + '</span>';
            ...
            if (s == parseInt(s) && s < 0) {
                ...
                if (n1 == 1 && n2 == 1) {
                    ...
                    var result = 'i&#8730<span style="text-decoration: overline">' + n2 + '</span>';
                    var result = 'i<span class="radical">&radic;</span><span class="radicand">' + n2 + '</span>';
                    ...
                    var text = '&#8730<span style="text-decoration: overline">(-1)(' + n1 * n1 + ")(" + n2 + ')</span> = ';
                    var result = n1 + 'i&#8730<span style="text-decoration: overline">' + n2 + '</span>';
                    var result = n1 + 'i<span class="radical">&radic;</span><span class="radicand">' + n2 + '</span>';
...
/*------------------------------------------------------------------------------
* NAME       :  FindRoots
* PURPOSE    :  Finds roots of quadratic equation
* PARAMETERS :  values of a,b,c, quadratic equation
* RETURNS    :  roots of quadratic equation
*----------------------------------------------------------------------------*/
    function FindRoots(aa, bb, cc, polyTemp, Equation) {
        var pm = String.fromCharCode(177);  //plus or minus
        var sup2 = String.fromCharCode(178);  //
        var textnum1, textnum2, textden1, textden2;

        var Disc = bb * bb - 4 * aa * cc;
        Disc = Math.round(Disc * 1000000000000) / 1000000000000;

        var NegB = -bb;
        NegB = Math.round(NegB * 1000000000000) / 1000000000000;

        var bb2 = bb * bb;
        bb2 = Math.round(bb2 * 1000000000000) / 1000000000000;
        ...
        //ifrm.document.write('<span style="font-size: x-large; color:green ">Input Equation:&nbsp;&nbsp;&nbsp;' + polyTemp + '</span><br><br>');

        document.getElementById('output2').innerHTML += '<span style="font-size: x-large; color:green ">Input Equation:&nbsp;&nbsp;&nbsp;' + polyTemp + '</span><br><br>';

        //ifrm.document.write("<span style='font-size: x-large'>Result: ");
        //document.getElementById('output2').innerHTML += "<span style='font-size: x-large'>Result: ";

        //ifrm.document.write('<br><br><br><br><br><br><br><br><br><br><br><br><br><br>');



        //ifrm.document.write("<span style='font-size: 30px'>Detailed Calculation <br><br>");
        document.getElementById('output').innerHTML += "<span style='font-size: 30px'>Detailed Calculation <br><br>";

        //ifrm.document.write('<span style="font-size: x-large; color:green ">Input Equation:&nbsp;&nbsp;&nbsp;' + polyTemp + '</span><br><br>');
        document.getElementById('output').innerHTML += '<span style="font-size: x-large; color:green ">Input Equation:&nbsp;&nbsp;&nbsp;' + polyTemp + '</span><br><br>';

        var text = "Rearrange input equation so that the right side is zero."
        //ifrm.document.write('<span style="font-size: x-large; ">' + text + '</span><br><br>');
        document.getElementById('output').innerHTML += text + '<br><br>';

        //ifrm.document.write('<span style="font-size: x-large; color:black ">Quadratic Equation Format:&nbsp;&nbsp;&nbsp;' + Equation + '</span><br><br>');
        document.getElementById('output').innerHTML += 'Quadratic Equation Format:&nbsp;&nbsp;&nbsp;' + Equation + '<br><br>';

        var text = "a = " + aa + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                             + " b = " + bb + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                             + " c = " + cc;
        //ifrm.document.write('<span style="font-size: x-large; color:black ">' + text + '</span><br><br>');
        document.getElementById('output').innerHTML += text + '<br><br>';

        var text = "<span>"
                        + "Since b = " + bb + ", -b = " + (-bb) + "<br/><br/>"
                        + "b" + sup2 + " = (" + bb + ")" + sup2 + " = " + (bb2) + "<br/><br/>"
                        + "4ac = 4(" + aa + ")(" + cc + ") = " + (4 * aa * cc) + "<br><br>"
                        + "Discriminant = b" + sup2 + " - 4ac = (" + bb + ")" + sup2 + " - 4(" + aa + ")(" + cc + ") = " + (Disc) + "<br/><br/>"
                        + "</span>";

        //ifrm.document.write(text);
        document.getElementById('output').innerHTML += text + '<br><br>';

        text = "If discriminant < 0 (or negative), then there will be two nonreal-complex solutions. <br>"
                     + "If discriminant = 0, then there will be one real solution. <br>"
                     + "If discriminant > 0 (or positive), then there will be two real solutions. <br><br>"
                     ;
        //ifrm.document.write("<span ='font-size: x-large'>" + text + "</span>");
        document.getElementById('output').innerHTML += text + '<br><br>';

        //ifrm.document.write('<br><br><br>');
        text = "Result:"
        //ifrm.document.write("<span style='font-size: x-large; color:blue'>" + text + "</span><br><br>");

        document.getElementById('output').innerHTML += "<span style='font-size: x-large; color:blue'>" + text + "</span><br><br>";

        text = "x = "
                + '<u>'
                + '-b ' + pm + '&#8730'
                + '<span style="text-decoration: overline">b' + sup2 + "- 4ac</span></span>"
                + '</u>'
                + '<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2a';

        //ifrm.document.write("<span style='font-size: x-large'>" + text + "</span><br><br>");

        var text2 = '<br><span >x = </span>'
                 + '<div class="fraction">'
                 + '<span class="fup">'
                 + '-b ' + pm + '<span class="radical">&radic;</span><span class="radicand">b<sup>2</sup> - 4ac</span>'
                 + '</span>'
                 + '<span class="bar">/</span>'
                 + '<span class="fdn">2a</span>'
                 + '</div>';
        ...
        text = "x = "
                + '<u>'
                + NegB + " " + pm + " " + '&#8730'
                + '<span style="text-decoration: overline; ">' + Disc + '</span>'
                + '</u>'
                + '<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2(' + aa + ")";
        ...
        var text2 = '<br><span >x = </span>'
                 + '<div class="fraction">'
                 + '<span class="fup">'
                 + NegB + '&nbsp;' + pm + '<span class="radical">&radic;</span><span class="radicand">' + Disc + '</span>'
                 + '</span>'
                 + '<span class="bar">/</span>'
                 + '<span class="fdn">2(' + aa + ')</span>'
                 + '</div>';

        document.getElementById('output').innerHTML += text2;

        var val1 = SIMPLIFY22(Disc);
        var val1B = SIMPLIFY22B(Disc);
        //var tu = (val1.toString()).indexOf("&#8730");
        //alert("tu = " + tu);
        ...
        //alert('val1 = ' + val1);
        //document.getElementById('output').innerHTML += '<br>' + val1 + '<br>';
        ...
        else if (val2.substring(0, 1) == "i") {
            vntt = val1;
        }
        else if (val2.indexOf("i&#8730") > -1 && val2.substring(0, 1) != "i") {
            var vnaa = val2.split("i&#8730");
            vntt = "i&#8730" + vnaa[1];
            vn2 = FindValue(vnaa[0].toString());
        }
        else if (val2.indexOf("&#8730") > -1 && val2.substring(0, 1) != "&") {
            var vnaa = val2.split("&#8730");
            vntt = "&#8730" + vnaa[1];
            vn2 = FindValue(vnaa[0].toString());
        }
        else if (val2.indexOf("i") > -1 && val2.substring(0, 1) != "i") {
            var vnaa = val2.replace("i", "");
            vntt = "i";
            vn2 = FindValue(vnaa.toString());
        }
        ...
        if (vn1 == parseInt(vn1) && vn2 == parseInt(vn2) && vn3 == parseInt(vn3)) {
            AllIntegers = true;
        }


        if (vn1 == 1 || vn2 == 1 || vn3 == 1) {
            AllIntegers = false;
        }

        //alert(vn1 + " ;;;;;;;;;;;; " + vn2 + " ;;; " + vn3);
        if (AllIntegers == true) {
            var v1 = Math.min(Math.abs(vn1), Math.abs(vn2));
            var v2 = Math.min(Math.abs(vn1), Math.abs(vn3));
            var v3 = Math.min(v1, v2);

            var t1 = vn1;
            var t2 = vn2;
            var t3 = vn3;
            var FindCommonFactor = false;

            for (var j = 2; j <= v3; j++) {
                if (Math.abs(vn1) % j == 0 && Math.abs(vn2) % j == 0 && Math.abs(vn3) % j == 0) {
                    t1 = vn1 / j;
                    t2 = vn2 / j;
                    t3 = vn3 / j;
                    FindCommonFactor = true;
                }
            }
            ...
            var text2 = '<br><span>x = </span>'
                 + '<div class="fraction2">'
                 + '<span class="fup">' + t1 + " " + pm + " " + th2 + vntt + '</span>'
                 + '</span>'
                 + '<span class="bar">/</span>'
                 + '<span class="fdn">' + t3 + '</span>'
                 + '</div>';
            ...
            if (t3 == 1) {
                text = "x = " + t1 + " " + pm + " " + th2 + vntt;
                text2 = 'x = ' + t1 + " " + pm + " " + th2 + vntt;
            }

            //ifrm.document.write("<span style='font-size: x-large'>" + text + "</span><br><br>");
            document.getElementById('output').innerHTML += '<br><br>' + text2 + '<br><br>';
        }
        ...
        var ttrr = text;
        var ttrr2 = text2;
        ttrr = ttrr.replace(pm, "+");
        ttrr2 = ttrr2.replace(pm, "+");
        ...
        //Approximate Answers
        var expr1 = -bb / (2 * aa);
        var expr2 = Math.sqrt(Math.abs(Disc)) / (2 * aa);
        //alert("expr1 = " + expr1 + " ;;; " + "expr2 = " + expr2);

        var FracFlag = false;
        var tt = Math.sqrt(Math.abs(Disc));
        if (parseInt(bb) == bb && parseInt(tt) == tt && parseInt(2 * aa) == 2 * aa) {
            var FracFlag = true;
        }


        if (Disc < 0) {
            text = "Approximate Answers:"
            text = "First &nbsp; Solution:&nbsp;&nbsp; x6666 = " + expr1 + " + " + expr2 + "<i>i</i>";
            ...
            text = "Second &nbsp; Solution:&nbsp;&nbsp; x7777 = " + expr1 + " - " + expr2 + "<i>i</i>";
            if (expr1 == 0) {
                text = "Second &nbsp; Solution:&nbsp;&nbsp; x8888 = " + "-" + expr2 + "<i>i</i>";
            }
            ...
            var thy3 = Math.round(expr1 * 1000000000000) / 1000000000000;
            var thy4 = Math.round(expr1 * 1000000000000) / 1000000000000;
            if (FracFlag == true && parseInt(thy3) != thy3) {
                thy3 = thy3 + ' = ' + ToFraction(thy3.toString());
            }
            if (FracFlag == true && parseInt(thy4) != thy4) {
                thy4 = thy4 + ' = ' + ToFraction(thy4.toString());
            }

        }
        else if (Disc > 0) {
            var thy3 = Math.round((expr1 + expr2) * 1000000000000) / 1000000000000; ;
            var thy4 = Math.round((expr1 - expr2) * 1000000000000) / 1000000000000; ;
            if (FracFlag == true && parseInt(thy3) != thy3) {
                thy3 = thy3 + ' = ' + ToFraction(thy3.toString());
            }
            if (FracFlag == true && parseInt(thy4) != thy4) {
        ...
        thy1b = thy1b.replace('<br>', '');
        thy2b = thy2b.replace('<br>', '');

        if (vntt == '') {
            //alert('654444444444444444');
            thy1b = thy1b.replace('x =', '');
            thy1b = 'x = <span class = "movedown1">' + thy1b + '</span>'
            thy2b = thy2b.replace('x =', '');
            thy2b = 'x = <span class = "movedown1">' + thy2b + '</span>'

        }

        var text2 = '<br><br><br>First Solution:<br><br>' + thy1b + ' = ' + thy3
                  + '<br><br><br>Second Solution:<br><br>' + thy2b + ' = ' + thy4;
        document.getElementById('output').innerHTML += text2 + '<br><br><br>';





        var text1 = "<span style='font-size: x-large'><br><br><u>First Solution:</u><br><br> " + thy1b + "    = " + thy3 + "</span><br><br>";
        var text2 = "<span style='font-size: x-large'><br><br><u>Second Solution:</u><br><br> " + thy2b + "  = " + thy4 + "</span><br><br><br><br>";
        //document.getElementById('output2').innerHTML += text1;
        //document.getElementById('output2').innerHTML += text2;

        //determines if square root of determinant is integer
        var ff = Math.sqrt(Disc);
        if(ff == parseInt(ff)){
            thy1b = thy1b + ' = ' + thy3;
            thy2b = thy2b + ' = ' + thy4;
        } 
        ...
        document.getElementById('output22').innerHTML = '' + thy1b;
        document.getElementById('output33').innerHTML = 'x = ' + thy3;
        document.getElementById('output44').innerHTML = '' + thy2b;
        document.getElementById('output55').innerHTML = 'x = ' + thy4;
...
/*------------------------------------------------------------------------------
* NAME       :  DivideConstant
* PURPOSE    :  Divides polynomial by constant
* PARAMETERS :  polynomial, constant
* RETURNS    :  polynomial
*----------------------------------------------------------------------------*/
    function DivideConstant(poly, constant) {
        ...
        var result = "";
        var trq = SplitPoly(poly); //temp1.split("+");

        var vv = FindValue(constant);
        for (var i = 0; i < trq.length; i++) {
            if (trq[i].indexOf("x") > -1) {
                var tt = trq[i].split('x');
                tt[0] = FindValue(tt[0]) / vv;
                trq[i] = tt[0] + "x" + tt[1];
            }

        }

        //alert("poly = " + poly + " ;;;; trq = " + trq);
...
* PURPOSE    :  Multiplies polynomial by constant
* PARAMETERS :  polynomial, constant
* RETURNS    :  polynomial
*----------------------------------------------------------------------------*/
    function MultiplyConstant(poly, constant) {
...
*----------------------------------------------------------------------------*/
    function ProcessPoly(str) {
            ...
            for (var i = 0; i < postFixTT.length; i++) {
                ...
                if (pp == '^' || pp == '*' || pp == '/' || pp == '+' || pp == '-') {
                    ...
                    if (postFixTT[i] == '+') {
                        ...
                        var tt = DivideByConstant(postFixTT[i - 2], postFixTT[i - 1]);
                        postFixTT[i] = tt;
                        postFixTT.splice(i - 2, 2);
                        break;
                    }
                    else if (postFixTT[i] == '^') {
                        var tt = postFixTT[i - 2];
        ...
        //alert('postFix3 = ' + postFixTT + '...... postFixTT length = ' + postFixTT.length);
...
*----------------------------------------------------------------------------*/
    function SplitPoly(poly) {
        ...
        //alert("trq1 = " + trq1);
        for (var i = 0; i < trq1.length; i++) {
            if (trq1[i].indexOf("xy") > -1) {
                var tru3 = trq1[i].split("xy");
                if (tru3[0] == "") {
                    tru3[0] = "1";
                }
                else if (tru3[0] == "-") {
            ...
            else if (trq1[i].indexOf("y") > -1) {
                if (trq1[i].indexOf("^") > -1) {
                    if (trq1[i].substring(0, 1) == "y") {
                        trq1[i] = "1" + trq1[i];
                    }
                    var tru2 = trq1[i].split("^");
                    if (tru2[0] == "y") {
            ...
            else if (trq1[i].indexOf("x") == -1 && trq1[i].indexOf("y") == -1) {
                trq1[i] = trq1[i] + "x^0";
            }
...
*----------------------------------------------------------------------------*/
    function DividePoly2(poly1, poly2) {
        ...
        //ifrm.document.write('<span style="font-size: large; color:blue">Quotient = ' + result + '</span><br>');
        //ifrm.document.write('<span style="font-size: large; ">Remainder = ' + ConvertSymbol(rr2) + '</span><br>');
        //ifrm.document.write('<span style="font-size: large; ">Divisor = ' + polytt2 + '</span><br>');

        if (rr2 != "0x^0") {
            result += ' + <sup>' + ConvertSymbol(rr2) + "</sup><span style='font-size:36px'>/</span><sub>(" + polytt2 + ")</sub>";
        }
        ...
        //ifrm.document.write('<span style="font-size: large; ">Result: <br>(' + polytt1 + ')/(' + polytt2 + ') = ' + result + '</span><br><br><br><br>');
...
/*------------------------------------------------------------------------------
* NAME       :  toFixed
* PURPOSE    :  Converts a number in engineering notation to long decimal
* PARAMETERS :  x = number in engineering
    ...
    function toFixed(x) {
        if (Math.abs(x) < 1.0) {
            ...
            if (e) {
                ...
                //alert("....x = " + x);
                if(x >= 0){
                    x = '0.' + (new Array(e)).join('0') + (x.toString().substring(2)).replace(".", "");
                }      
                else{
                    x = '-0.' + (new Array(e)).join('0') + (x.toString().substring(2)).replace(".", "");
                }  
...
/*------------------------------------------------------------------------------
* NAME       :  SimplifyEquation
* PURPOSE    :  Simplify input quadratic equation and finds values of a, b, c
* PARAMETERS :  quadratic equation
* RETURNS    :  values of a, b, c
*----------------------------------------------------------------------------*/
    function SimplifyEquation() {
        var poly = document.getElementById("inputtextbox").value;
        if (poly.indexOf('=') == -1) {
            alert('Since you did not specify the right side of the quadratic equation, the right side will be assumed to be zero.')
            poly = poly + ' = 0';
            document.getElementById("inputtextbox").value = poly;
        }
        var polyTemp = poly;
        if (poly == "") { return; }
        poly = replaceAll(poly, " ", "");
        ...
        var tru = poly.split("=");
        var LeftsideArray = ProcessPoly(tru[0]);
        var RightsideArray = ProcessPoly(tru[1]);

        //alert("leftsideArray = " + LeftsideArray + ";;; RightsideArray = " + RightsideArray);

        var PolyArray1 = SplitPoly(LeftsideArray);
        var PolyArray2 = SplitPoly(RightsideArray);

        var deg1 = polyDegree(PolyArray1);
        var deg2 = polyDegree(PolyArray2);
        var deg = Math.max(deg1, deg2);
        //alert("deg1 = " + deg1 + " ;;; " + "deg2 = " + deg2 + " ;;; " + "deg = " + deg);
        
        if(deg < 2 || deg > 2){
            var msg = 'Input equation is not a quadratic equation.'
                + '\n\nThis program only solves quadratic equation.\n\n\n\n';
        ...
        for (var i = 0; i < PolyArray2.length; i++) {
            if (PolyArray2[i].indexOf("xy") > -1) {
                var tt = PolyArray2[i].split("xy");
                if (tt[0] == "") {
                    tt[0] = "1";
                }
                else if (tt[0] == "-") {
                ...
                PolyArray2[i] = (-1 * FindValue(tt[0])) + "xy";

            }
            else if (PolyArray2[i].indexOf("x^") > -1) {
                var tt = PolyArray2[i].split("x^");
                PolyArray2[i] = -1 * FindValue(tt[0]) + "x^" + tt[1];
            }
            else if (PolyArray2[i].indexOf("y^") > -1) {
        ...
        var Equation = SumX222 + 'x<sup>2</sup> + ' + SumX111 + "x + " + cc + " = 0 ";
        Equation = replaceAll(Equation, " ", "");

        Equation = RemovePM(Equation);
        Equation = Equation.replace("=", " = ");


        FindRoots(aa, bb, cc, polyTemp, Equation);
...
/*------------------------------------------------------------------------------
* NAME       :  ConvertSymbol2
* PURPOSE    :  Converts 'x2' to 'x²', 'x3' to 'x³', ....
* PARAMETERS :  string 
* RETURNS    :  string
*----------------------------------------------------------------------------*/
   function ConvertSymbol2() { 
        ...
        var expr = document.getElementById("inputtextbox").value;
        if (expr.indexOf('x2') > -1) {
            expr = replaceAll(expr, 'x2', 'x' + sup2);
        }
        if (expr.indexOf('x3') > -1) {
            expr = replaceAll(expr, 'x3', 'x' + sup3);
        }
        if (expr.indexOf('x4') > -1) {
            expr = replaceAll(expr, 'x4', 'x' + sup4);
        }
        if (expr.indexOf('x5') > -1) {
            expr = replaceAll(expr, 'x5', 'x' + sup5);
        }
        if (expr.indexOf('x6') > -1) {
            expr = replaceAll(expr, 'x6', 'x' + sup6);
        }
        if (expr.indexOf('x7') > -1) {
            expr = replaceAll(expr, 'x7', 'x' + sup7);
        }
 
        document.getElementById("inputtextbox").value = expr;
