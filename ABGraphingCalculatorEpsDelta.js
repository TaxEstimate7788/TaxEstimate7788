...
//alert('gggggg.....'+rdata );        
 ...
 ////////////////////
     ...
     function draw() {
        ...
        //draw epsilon-delta limit

        var dataX1 =  document.getElementById("Point1X").value;
        var dataX2 =  document.getElementById("Point2X").value;
        var dataX3 =  document.getElementById("Point3X").value;
        var dataX4 =  document.getElementById("Point4X").value;
        var dataX5 =  document.getElementById("Point5X").value;
        var dataX6 =  document.getElementById("Point6X").value;
        var dataX7 =  document.getElementById("Point7X").value;
        var dataX8 =  document.getElementById("Point8X").value;
        var dataX9 =  document.getElementById("Point9X").value;
        var dataX10 =  document.getElementById("Point10X").value;
        var dataX11 =  document.getElementById("Point11X").value;
 
        var dataY1 =  document.getElementById("Point1Y").value;
        var dataY2 =  document.getElementById("Point2Y").value;
        var dataY3 =  document.getElementById("Point3Y").value;
        var dataY4 =  document.getElementById("Point4Y").value;
        var dataY5 =  document.getElementById("Point5Y").value;
        var dataY6 =  document.getElementById("Point6Y").value;
        var dataY7 =  document.getElementById("Point7Y").value;
        var dataY8 =  document.getElementById("Point8Y").value;
        var dataY9 =  document.getElementById("Point9Y").value;
        var dataY10 =  document.getElementById("Point10Y").value;
        var dataY11 =  document.getElementById("Point11Y").value;
       

        var dashFlag = "0";
        var dataXt = dataX1+';'+ dataX7;//+';'+ dataX3;
        var dataYt = dataY1+';'+ dataY7;//+';'+ dataY3;
        dataX = dataXt.split(';');
        dataY = dataYt.split(';');

        funGraph(ctx, "LIMIT", 'orange', 3,  dataX, dataY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag);
        var dataXt = dataX7+';'+ dataX6;//+';'+ dataX3;
        var dataYt = dataY7+';'+ dataY6;//+';'+ dataY3;
        dataX = dataXt.split(';');
        dataY = dataYt.split(';'); 
        funGraph(ctx, "LIMIT", 'orange', 3,  dataX, dataY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag);
 
        var dataXt = dataX2+';'+ dataX8;//+';'+ dataX3;
        var dataYt = dataY2+';'+ dataY8;//+';'+ dataY3;
        dataX = dataXt.split(';');
        dataY = dataYt.split(';');

        funGraph(ctx, "LIMIT", 'green', 3,  dataX, dataY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag);
        var dataXt = dataX8+';'+ dataX9;//+';'+ dataX3;
        var dataYt = dataY8+';'+ dataY9;//+';'+ dataY3;
        dataX = dataXt.split(';');
        dataY = dataYt.split(';'); 
        funGraph(ctx, "LIMIT", 'green', 3,  dataX, dataY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag);

        var dataXt = dataX3+';'+ dataX4;//+';'+ dataX3;
        var dataYt = dataY3+';'+ dataY4;//+';'+ dataY3;
        dataX = dataXt.split(';');
        dataY = dataYt.split(';');

        funGraph(ctx, "LIMIT", 'orange', 3,  dataX, dataY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag);
        var dataXt = dataX4+';'+ dataX5;//+';'+ dataX3;
        var dataYt = dataY4+';'+ dataY5;//+';'+ dataY3;
        dataX = dataXt.split(';');
        dataY = dataYt.split(';'); 
        funGraph(ctx, "LIMIT", 'orange', 3,  dataX, dataY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag);
        ...
        var dataX11 = x0 + dataX1 * dxx;
        var dataY11 = y0 - dataY1 * dyy;
        var dataX22 = x0 + dataX2 * dxx;
        var dataY22 = y0 - dataY2 * dyy;
        var dataX33 = x0 + dataX3 * dxx;
        var dataY33 = y0 - dataY3 * dyy;
        var dataX44 = x0 + dataX4 * dxx;
        var dataY44 = y0 - dataY4 * dyy;
        var dataX55 = x0 + dataX5 * dxx;
        var dataY55 = y0 - dataY5 * dyy;
        var dataX66 = x0 + dataX6 * dxx;
        var dataY66 = y0 - dataY6 * dyy;
        var dataX77 = x0 + dataX7 * dxx;
        var dataY77 = y0 - dataY7 * dyy;
        var dataX88 = x0 + dataX8 * dxx;
        var dataY88 = y0 - dataY8 * dyy;
        var dataX99 = x0 + dataX9 * dxx;
        var dataY99 = y0 - dataY9 * dyy;

        ctx.globalAlpha = 0.4; //transparency level
        ctx.beginPath();
        ctx.moveTo(dataX11,dataY11);
        ctx.lineTo(dataX22,dataY22);
        ctx.lineTo(dataX88,dataY88);
        ctx.lineTo(dataX99,dataY99);
        ctx.lineTo(dataX66,dataY66);
        ctx.lineTo(dataX77,dataY77);
        ctx.lineTo(dataX11,dataY11);
        ctx.closePath();
        ctx.stroke();
        ctx.fillStyle="gray";
        ctx.fill();
        ...
        ctx.beginPath();
        ctx.moveTo(dataX22,dataY22);
        ctx.lineTo(dataX33,dataY33);
        ctx.lineTo(dataX44,dataY44);
        ctx.lineTo(dataX55,dataY55);
        ctx.lineTo(dataX99,dataY99);
        ctx.lineTo(dataX88,dataY88);
        ctx.lineTo(dataX22,dataY22);
        ctx.closePath();
...
$(document).ready(function(){		
 $('input').keydown(function(e){		
  ...
  function ExampleEpsDelta(){
      ...
      document.getElementById('epsilonvalue').value = "0.5";
      document.getElementById('deltavalue').value = "0.1";
      document.getElementById('xMinParameter').value = '-1.25' ;
      document.getElementById('xMaxParameter').value = '2.5';
      document.getElementById('yMinParameter').value = '-1.25';
      document.getElementById('yMaxParameter').value = '2.5';
  ...
  function ExampleEpsDelta2(){
      ...
      document.getElementById('xMaxParameter').value = '3.125';
      document.getElementById('yMinParameter').value = '-1';
  ...
  function ExampleEpsDelta3(){
      ...
      document.getElementById('epsilonvalue').value = "0.5";
      document.getElementById('deltavalue').value = "0.1";
      document.getElementById('xMinParameter').value = '-1.14583' ;
      document.getElementById('xMaxParameter').value = '3.97916';
      document.getElementById('yMinParameter').value = '-1.7916';
      document.getElementById('yMaxParameter').value = '2.9583';
...
function insertAtCaret(element, text, val1, val2, val3, val4) {
   ...
   function Textboxongrid22BB(casenum) {
    ...
    function showcontinuity() {
        ...
        document.getElementById('leftsidelimit').innerHTML = 'Limit from the left: x approaches ' + limval + ' from the left.'
        document.getElementById('rightsidelimit').innerHTML = 'Limit from the right: x approaches ' + limval + ' from the right.'
        ...
        document.getElementById('TableDataLimitY1C').innerHTML = '<br><br>a) Determine if f('+x+') is defined.'
             + "<br><br>&nbsp;&nbsp;&nbsp;&nbsp;Note: When x = " + XH + " , &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; y = f("+XH + ") =  " + y + "<br><br>";

        var text = 'b) Determine if limit of f(x) exists as x approaches ' + x + '.'
                 + '<br><br>&nbsp;&nbsp;&nbsp;&nbsp;Note: The values in the tables below can help us determine <br> &nbsp;&nbsp;&nbsp;&nbsp;whether or not'
                 + ' limit of f(x) exists as x approaches ' + x + '.';

        document.getElementById('TableDataLimitY1C').innerHTML += text;


        if(isNaN(y) == false){
            document.getElementById('Point19X').value = x;
            document.getElementById('Point19Y').value = y;
            document.getElementById('checkboxCartesianPoints').checked = true;
    ...
    function GraphEpsDel() {
        ...
        //identify right side of selected equation 
        var RightSideEquation = document.getElementById('LimitFunction').value;
        var InputExpression = document.getElementById('LimitFunction').value;
        ...
        var epsilon = document.getElementById('epsilonvalue').value;
        var delta = document.getElementById('deltavalue').value;
        delta = replaceAll(delta, epsilonsymbol, '(' + epsilon + ')');
        delta = FindValue(delta);
        var CminusDel = parseFloat(Cvalue) - parseFloat(delta);
        var CplusDel = parseFloat(Cvalue) + parseFloat(delta);
        var LminusEps = parseFloat(Lvalue) - parseFloat(epsilon);
        ...
        var text1 = 'c - ' + deltasymbol  + ' = ' + CminusDel +'<br>';
        var text1 = text1 + 'c + ' + deltasymbol  + ' = ' + CplusDel +'<br>';
        var text1 = text1 + '(c - ' + deltasymbol + ', c + ' + deltasymbol + ') = (' + CminusDel + ' , '+ CplusDel+')<br><br>';
        var text11 = '(c - ' + deltasymbol + ', c + ' + deltasymbol + ') = (' + CminusDel + ' , '+ CplusDel+')<br><br>';


        document.getElementById('SpanEpsilon02').innerHTML =  '(c - ' + deltasymbol + ', c + ' + deltasymbol + ') = (' + CminusDel + ' , '+ CplusDel+')';


        //var text1 = text1 + 'c - ' + deltasymbol + ' = ' + CminusDel + ')<br>';
        //var text1 = text1 + 'c + ' + deltasymbol + ' = ' + CplusDel + ')<br>';
        //var text1 = text1 + '(c - ' + deltasymbol + ', c + ' + deltasymbol + ') = (' + CminusDel + ' , '+ CplusDel+')<br><br>';
        
        
        var text1 = text1 + 'L - ' + epsilonsymbol + ' = ' + LminusEps  +'<br>';
        var text1 = text1 + 'L + ' + epsilonsymbol + ' = ' + LplusEps + '<br>';        
        var text1 = text1 + '(L - ' + epsilonsymbol + ', L + ' + epsilonsymbol + ') = (' + LminusEps  + ' , '+ LplusEps +')<br><br>';
        var text22 = '(L - ' + epsilonsymbol + ', L + ' + epsilonsymbol + ') = (' + LminusEps  + ' , '+ LplusEps +')<br><br>';
        
        document.getElementById('SpanEpsilon01').innerHTML = '(L - ' + epsilonsymbol + ', L + ' + epsilonsymbol + ') = (' + LminusEps  + ' , '+ LplusEps +')';

        

        document.getElementById('TableDataLimitY1').innerHTML = text1;
        document.getElementById('TableDataLimitY1Bepsdel').innerHTML = '<br>' +  text11 + text22;

        var text3 = 'In the table below, the "x" column contains values that lie in (c - ' + deltasymbol +' , c) or <br> '
                  + '(c, c + ' + deltasymbol + ').<br>'   
                  + 'Note: x ∈ (c - ' + deltasymbol +' , c) means that 0 < |x - c| < ' + deltasymbol +'<br>'   
                  +  'and x ∈ (c , c + ' + deltasymbol + ') also means that 0 < |x - c| < ' + deltasymbol +'<br><br>';     
        
        document.getElementById('TableDataLimitY1C').innerHTML = text3;

        var text4 = 'What we would like to see is that for each x that lies in (c - ' + deltasymbol + ' , c) or <br> '
                  + '(c, c + ' + deltasymbol + ') '
                  + ', its corresponding f(x) lies in ' + '(L - ' + epsilonsymbol + ', L + ' + epsilonsymbol + '). ';

        var text4 = text4 + '<br>The third column shows whether or not f(x) lies in ' + '(L - ' + epsilonsymbol + ', L + ' + epsilonsymbol + ').<br>';

        var text4 = text4 + '<br>Note: f(x) lies in ' + '(L - ' + epsilonsymbol + ', L + ' + epsilonsymbol + ') means that ' 
        + ' |f(x) - L| < ' + epsilonsymbol+'.';

        document.getElementById('TableDataLimitY1C').innerHTML += text4;
        ...
        document.getElementById('TableDataLimitY1').innerHTML += '(f(c - ' + deltasymbol + ') , ' + 'f(c + ' + deltasymbol + ')) = (' + y1 + ' , ' + y2   + ')<br><br>';
        ...
        for (var tt = CminusDel + stepsize; tt < Cvalue; tt += stepsize) {
        ...
        var stepsize = (CplusDel - Cvalue)/100;
        for (var tt = Cvalue + stepsize; tt < CplusDel; tt += stepsize) {
            var temp1 = replaceAll(InputExpression, "x", "(" + tt + ")");
            y = FindValue(temp1);
        ...
        xdata = xdata.substring(1);
        ydata = ydata.substring(1);
        zdata = zdata.substring(1);
        var TableName = 'TableDataLimitY1B';
        var colorTable = 'blue';
        //alert('zdata.....' + zdata);
        tableCreateLimit(xdata, ydata, zdata, colorTable, TableName,RightSideEquation);
    ...
    function tableCreateLimit(xdata, ydata, zdata,color,TableName,RightSideEquation) {        
        var epsilonsymbol = String.fromCharCode(949);
	    var deltasymbol = String.fromCharCode(948);	
        var body = document.body,
        tbl = document.createElement('table');
        ...
        td.appendChild(document.createTextNode('x ∈ (c - ' + deltasymbol + ' , c + ' + deltasymbol + ')' ));
        ...
        td.style.color = color;
        td.style.borderColor = color;
        td.appendChild(document.createTextNode('f(x) ∈ (L-' + epsilonsymbol + ' , L+' + epsilonsymbol + ')?' ));
