 ...
 ////////////////////
   ...
   function findIVT() {
        ...
        if (tt.indexOf('x') > -1) {//case 3:  directrix is vertical (x = c) and focus is right
            ...
            document.getElementById('TextBoxForCartesianGraph2').value = tt2[1];
     ...
     function draw() {
       ...
       if(document.getElementById('drawSegmentcheckbox').checked){
        ...
        if (document.getElementById('segmentsOnGraph').checked) {            
            var NN = document.getElementById('NumberOfSegments').value//number of segments on grid
            //alert('NN='+NN);
            for (var i = 1; i <= NN; i++) {
                if (document.getElementById('typeofDirectrix').value == '1' || document.getElementById('typeofDirectrix').value == '2') {//directrix to the left of pole
                    ...
                    var dd = document.getElementById('TextBoxForCartesianGraph2').value;
                    dataX = [xxt, dd];
                    dataY = [yyt,yyt];
