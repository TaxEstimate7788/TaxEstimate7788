    ...
    function GraphingCalculator() {
        ...
        for (var i = 1; i <= 20; i++) {
            ...
            if (rightsideinputequation != "" && statusCheckbox == true) {
                ...
                var tta = (rightsideinputequation.indexOf(' hyperbolaxy') == -1);
                var ttb = (rightsideinputequation.indexOf('hyperbolaYX') == -1);

                //alert('tta...' + tta);
                if (tta == false && ttb == false) {
                ...
                if (parseInt(valuedropbox) <= 4) {
                    ...
                    else if (InputExpression.indexOf(" hyperbolaxy") > -1) {//ppp;
 ...
 ////////////////////
     ...
     function draw() {
      ...
      if(document.getElementById('segmentsOnGraph').checked){
            ctx.globalAlpha = 1;
            var FocusX = FindValue(document.getElementById('Avalue').value);
            var FocusY = FindValue(document.getElementById('Bvalue').value);
            var FocusX2 = FindValue(document.getElementById('Cvalue').value);
            var FocusY2 = FindValue(document.getElementById('Dvalue').value);
            var NN = parseFloat(document.getElementById('NumberOfSegments').value);//number of segments on grid


            for (var i = 5; i <= NN+4; i++) {
                var xtt = document.getElementById('Point' + i + 'X').value;
                var ytt = document.getElementById('Point' + i + 'Y').value;
                if ((IsNumericc(xtt) == false) || (IsNumericc(ytt) == false) || (IsNumericc(FocusX) == false) || (IsNumericc(FocusY) == false) || (IsNumericc(FocusX2) == false) || (IsNumericc(FocusY2) == false)) {
                    //do nothing
                }
                else {
                    ctx.globalAlpha = 1;
        ...
        //draw secant line
         if ((document.getElementById('secantlinedata').value).indexOf(';;;') > -1) {
             //if (document.getElementById('showsecantline').checked) {
                 var dataSecant = document.getElementById('secantlinedata').value;
                 //alert('dataSecant....' + dataSecant);
                 var dataSecant2 = dataSecant.split(';;;');
                 var dataX = [2, 7];//(dataSecant2[0]).split(';');
                 var dataY = [3, 9];//(dataSecant2[1]).split(';');
                 //alert('dataX....' + dataX);
                 //alert('dataY....' + dataY); 
        ...
        //draw tangent linevar condition1 = ;
        ctx.globalAlpha = 1;
        if ((document.getElementById('tangentlinedata').value).indexOf(';;;') > -1) {
            //if (document.getElementById('showtangentline').checked) {
                var dataTangent = document.getElementById('tangentlinedata').value;
                var dataTangent2 = dataTangent.split(';;;');
                var dataX = (dataTangent2[0]).split(';');
                var dataY = (dataTangent2[1]).split(';');
                funGraph(ctx, "LIMIT", 'purple', 3, dataX, dataY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag, '0.3');
                ctx.globalAlpha = 1;
                traparentlevel = 1;
            //}
        }
         ...
         if (document.getElementById("checkboxCartesianPoints").checked) {
                ...
                for (var i = 1; i <= 20; i++) {
                    ...
                    if (coordX != "" && coordY != "" && PlotStatus) {
                        ...
                        if(document.getElementById('labelpoints').checked){
                        ...
                        if (OpenClose) {
                            ...
                            if (i == 1) {
                                ...
                                Label = 'F1';
                                ctx.fillText(Label, xcoord , ycoord + 25);
                                ctx.stroke();
                                ctx.closePath();
                            }
                            else if (i == 2) {
                                ...
                                ctx.font="20px Georgia";
                                Label = 'V1';
                                ctx.fillText(Label, xcoord+10 , ycoord + 25);
                                ctx.stroke();
                                ctx.closePath();
                            }
                            else if (i == 4) {
                                ...
                                ctx.font="20px Georgia";
                                Label = 'A';
                                ctx.fillText(Label, xcoord , ycoord - 15);
                                ctx.stroke();
                                ctx.closePath();
                            }
                            else if (i == 6) {
                                ...
                                ctx.font="20px Georgia";
                                Label = 'B';
                                ctx.fillText(Label, xcoord , ycoord + 20);
                                ctx.stroke();
                                ctx.closePath();
                            }
                            else if (i == 7) {
                                ...
                                if(i>= 5 && i<= 16){
                                    ...
                                    Label = lettersArray[i-5] + Label;Label = '';
                                }
       ...
       //Plot cartesian point (second set);
        var pointSize = 4;
        var dataPointArray = document.getElementById('PointArray3').value;
        var dataPointArray22 = dataPointArray.split(';;');
        ...
        for (var i = 0; i < dataPointArray22.length ; i++) {
            ...
            var coordX = XYdata22[0];
            var coordY = XYdata22[1];
            var xt = parseFloat(coordX);//FindValue(coordX);
            var yt = parseFloat(coordY);//FindValue(coordY);
       ...
       //draw segment;
       if(document.getElementById('drawSegmentcheckbox').checked){
          //alert('segment');
          var dataArray = document.getElementById('PointArray2').value;
          var dataArray22 = dataArray.split(';');
          //alert('segment22.........'  + dataArray22);
          var x1 = x0 + parseFloat(dataArray22[0]) * dxx; 
          var y1 = y0 - parseFloat(dataArray22[1]) * dxx; 
          var x2 = x0 + parseFloat(dataArray22[2]) * dxx; 
          var y2 = y0 - parseFloat(dataArray22[3]) * dxx; 
          var x3 = x0 + parseFloat(dataArray22[4]) * dxx; 
          var y3 = y0 - parseFloat(dataArray22[5]) * dxx; 
...
///////////////////  SHADING  //////////////////////////////
        ...
        if (document.getElementById('labelyaxispi').checked) {
            ...
            for (var i = startPi; i <= EndPi; i++) {                
                ...
                if (LabelLocationY > 500) {
                    context.fillText(LabelPI, LabelLocationY-15, yy+2);
                    context.fillText(emdash, 530, yy);
                }
                else {
                    context.fillText(LabelPI, LabelLocationY-15, yy+2);
                    context.fillText(emdash, x0, yy + 2);
                }
            }
            context.fillStyle = "black";
    ...
    function getDataConic(Expression, npoints, graphtype, conictype) {
        ...
        if (conictype == "ellipse") {
            ...
            //alert("hello getData   hyperbolaxy h = " + h + "......k = " + k + "...... a = " + a + "......b = " + b);
            ...
            //alert("hello getData  hyperbolaYX h = " + h + "......k = " + k + "...... a = " + a + "......b = " + b);
...
function insertAtCaret(element, text, val1, val2, val3, val4) {
   ...
   function Textboxongrid22BB(casenum) {
    ...
    function ClearGraphs() {
        document.getElementById('tangentlinedata').value = '';
        document.getElementById('secantlinedata').value = '';
    ...
    function Example1ivt(){
        ...
        document.getElementById('Cvalue').value = '-5';
        document.getElementById('Dvalue').value = '0';
        document.getElementById('NumberOfSegments').value = '0';
        findIVT();
    }
    ...
    function Example2ivt(){
        ...
        document.getElementById('Dvalue').value = '-5';
        document.getElementById('NumberOfSegments').value = '0';
        findIVT();
    }

     function Example3ivt(){
       document.getElementById('LimitFunction').value = '2';
        document.getElementById('Avalue').value = '4';
        document.getElementById('Bvalue').value = '0';
        document.getElementById('Cvalue').value = '-5';
        document.getElementById('Dvalue').value = '0';
        document.getElementById('NumberOfSegments').value = '0';
     ...
     function Example4ivt(){
       document.getElementById('LimitFunction').value = '3';
        document.getElementById('Avalue').value = '5';
        document.getElementById('Bvalue').value = '0';
        document.getElementById('Cvalue').value = '-5';
        document.getElementById('Dvalue').value = '0';
     ...
     function Example5ivt(){
       document.getElementById('LimitFunction').value = '6';
        document.getElementById('Avalue').value = '5';
        document.getElementById('Bvalue').value = '0';
        document.getElementById('Cvalue').value = '-5';
        document.getElementById('Dvalue').value = '0';
    ...
    function Example6ivt(){
        document.getElementById('LimitFunction3').value = '0.5x² +2x -1';
        document.getElementById('LimitFunction4').value = 'x +2';
        document.getElementById('Avalue2').value = '-6';
        document.getElementById('Bvalue2').value = '3';
        //document.getElementById('Lvalue').value = '5';
        //deltachange('1');
    }
    ...
    function Example7ivt(){
        //alert('7777');
        document.getElementById('LimitFunction3').value = '-x³+3x';
        document.getElementById('LimitFunction4').value = '-3x²+3';
        document.getElementById('Avalue2').value = '-2';
        document.getElementById('Bvalue2').value = '2';
        
        //deltachange('1');
    }

     function Example8ivt(){
        //alert('7777');
        document.getElementById('LimitFunction3').value = '√ ̅(3x+2)';
        document.getElementById('LimitFunction4').value = '1.5(3x+2)^(-0.5)';
        document.getElementById('Avalue2').value = '0';
        document.getElementById('Bvalue2').value = ' 4';

        //deltachange('1');
    }   
     function Example9ivt(){
        //alert('7777');
        document.getElementById('LimitFunction3').value = 'Cos(x)';
        document.getElementById('LimitFunction4').value = '-Sin(x)';
        document.getElementById('Avalue2').value = '1';
        document.getElementById('Bvalue2').value = '10';

        //deltachange('1');
    }   

     function Example10ivt(){
        //alert('7777');
        document.getElementById('LimitFunction3').value = 'Cos(x)+Sin(x)';
        document.getElementById('LimitFunction4').value = '-Sin(x)+Cos(x)';
        document.getElementById('Avalue2').value = '1';
        document.getElementById('Bvalue2').value = '8';
   ...
   function findIVT() {
        ...
        var PIsymbol = String.fromCharCode(960);   //PI
        var InputExpression = document.getElementById('LimitFunction').value; //directrix
        var InputExpression2 = document.getElementById('LimitFunction2').value;
        ...
        document.getElementById('TextBoxForCartesianGraph19').value = ''; 
        //if (document.getElementById('showderivfnc').checked) {
        //    document.getElementById('TextBoxForCartesianGraph19').value = document.getElementById('LimitFunction2').value;//f'(x)
        //}
        ...
        Avalue =   FindValue(Avalue);
        Bvalue =   FindValue(Bvalue);
        Cvalue =   FindValue(Cvalue);
        Dvalue =   FindValue(Dvalue);

        document.getElementById('Point1X').value = Avalue;
        document.getElementById('Point1Y').value = Bvalue;
        document.getElementById('Point2X').value = Cvalue;
        document.getElementById('Point2Y').value = Dvalue;

        var dd = document.getElementById('LimitFunction').value; //input constant
        dd =   FindValue(dd);
        ...
        //pointsonparabola
        document.getElementById('pointsonparabola').value = '';

        
        var tt = document.getElementById('LimitFunction').value;
        
        if (parseFloat(Bvalue) == parseFloat(Dvalue)) {//case 1:  hyperbola with branches left/right
            var cc2 = Math.abs(parseFloat(Avalue) - parseFloat(Cvalue));
            if(cc2 > parseFloat(dd)){
                //alert('Input constant d must be greater than the distance between the two fixed points (foci).');
                //return;
            }

            var cc = cc2/2;
            var aa = parseFloat(dd) / 2;
            var aa2 = aa * aa;
            var bb2 = cc*cc - aa2;
            var bb = Math.sqrt(bb2);

            
            var hh = (parseFloat(Avalue) + parseFloat(Cvalue)) / 2;
            var kk = parseFloat(Bvalue);
            var ftn = ' hyperbolaxy('+hh+'; '+kk+'; '+aa2+'; '+bb2+')'
            document.getElementById('pointsonparabola').value = 'case1';
            document.getElementById('mydropdownCartesian1').value = 0;
            document.getElementById('TextBoxForCartesianGraph1').value = ftn;
            document.getElementById('Point3X').value = hh + aa;//vertex 1
            document.getElementById('Point3Y').value = kk;
            document.getElementById('Point4X').value = hh - aa; //vertext 2
            document.getElementById('Point4Y').value = kk;
            document.getElementById('Point17X').value = hh; //M1
            document.getElementById('Point17Y').value = kk+bb;
            document.getElementById('Point18X').value = hh; //M2 
            document.getElementById('Point18Y').value = kk-bb;
            document.getElementById('Point19X').value = hh;
            document.getElementById('Point19Y').value = kk;
            var ftn11 = '('+bb+')((x-' + '(' + hh + ')' + ')^2/'+aa2+' - 1)^(1/2) + ' + '('+kk+')';
            var ftn22 = '-('+bb+')((x-' + '(' + hh + ')' + ')^2/'+aa2+' - 1)^(1/2) + ' + '('+kk+')';
            document.getElementById('TextBoxForCartesianGraph1').value = ftn11;
            document.getElementById('TextBoxForCartesianGraph2').value = ftn22;
       GraphingCalculator();
       //alert('aa2..' + aa2 +'.....cc'+ cc + '.....bb2...' + bb2 );
       //return;
     
            var xArray = [];
            var yArray = [];

            var stepsize = parseInt(cc) / 3;
            xArray[1] = hh - aa - 1; yArray[1] = FindValue(ftn11.replace('x', '(' + xArray[1] + ')'));//alert(xArray[1]+'...1..'+yArray[1]);
            xArray[2] = hh - aa - 1; yArray[2] = FindValue(ftn22.replace('x', '(' + xArray[2] + ')'));//alert(xArray[2]+'...2..'+yArray[2]);
            xArray[3] = hh - aa - 3; yArray[3] = FindValue(ftn11.replace('x', '(' + xArray[3] + ')'));//alert(xArray[3]+'...3..'+yArray[3]);
            xArray[4] = hh - aa - 3; yArray[4] = FindValue(ftn22.replace('x', '(' + xArray[4] + ')'));//alert(xArray[4]+'...4..'+yArray[4]);
            xArray[5] = hh - aa - 5; yArray[5] = FindValue(ftn11.replace('x', '(' + xArray[5] + ')'));//alert(xArray[5]+'...5..'+yArray[5]);
            xArray[6] = hh - aa - 5; yArray[6] = FindValue(ftn22.replace('x', '(' + xArray[6] + ')'));//alert(xArray[6]+'...6..'+yArray[6]);

            xArray[7] = hh + aa + 5; yArray[7] = FindValue(ftn11.replace('x', '(' + xArray[7] + ')'));
            xArray[8] = hh + aa + 5; yArray[8] = FindValue(ftn22.replace('x', '(' + xArray[8] + ')'));
            xArray[9] = hh + aa + 3; yArray[9] = FindValue(ftn11.replace('x', '(' + xArray[9] + ')'));
            xArray[10] = hh + aa + 3; yArray[10] = FindValue(ftn22.replace('x', '(' + xArray[10] + ')'));
            xArray[11] = hh + aa + 1; yArray[11] = FindValue(ftn11.replace('x', '(' + xArray[11] + ')'));
            xArray[12] = hh + aa + 1; yArray[12] = FindValue(ftn22.replace('x', '(' + xArray[12] + ')'));
            //xArray[13] = hh ; yArray[13] = FindValue(ftn.replace('x', '(' + xArray[13] + ')'));

            document.getElementById('TableDataLimitY1C').innerHTML = '';
            
            document.getElementById('TableDataLimitY1C').innerHTML += 'a = distance from center to V1 = ' + aa + '<br>';
            document.getElementById('TableDataLimitY1C').innerHTML += 'c = distance from center to F1 = ' + cc + '<br>';
            document.getElementById('TableDataLimitY1C').innerHTML += 'b = distance from center to M1 = ' + bb + '<br>';
            document.getElementById('TableDataLimitY1C').innerHTML += '<span style="color:red; font-size:24px">Note:  Input constant <i>d</i> = 2a = ' + dd + '</span><br>';

            document.getElementById('TableDataLimitY1C').innerHTML += 'a<sup>2</sup> = ' + aa2 + '<br>';
            document.getElementById('TableDataLimitY1C').innerHTML += 'c<sup>2</sup> = ' + cc*cc + '<br>';
            document.getElementById('TableDataLimitY1C').innerHTML += 'b<sup>2</sup> = ' + bb2 + '<br>';
            document.getElementById('TableDataLimitY1C').innerHTML += 'Note: c<sup>2</sup> = a<sup>2</sup> + b<sup>2</sup><br>';
            document.getElementById('TableDataLimitY1C').innerHTML += 'Note: b<sup>2</sup> = c<sup>2</sup> - a<sup>2</sup><br><br><br>';

            for (var i = 5; i <= 16; i++) {
                document.getElementById('Point'+i+'X').value =  xArray[i-4];
                document.getElementById('Point'+i+'Y').value = yArray[i-4];

 
                var dd1 = Math.sqrt(Math.pow(parseFloat(xArray[i - 4]) - parseFloat(Avalue), 2) + Math.pow(parseFloat(yArray[i - 4]) - parseFloat(Bvalue), 2));
                var dd2 = Math.sqrt(Math.pow(parseFloat(xArray[i - 4]) - parseFloat(Cvalue), 2) + Math.pow(parseFloat(yArray[i - 4]) - parseFloat(Dvalue), 2));
                //alert('////' + xArray[i - 4] + '/////' + yArray[i - 4]);

                var text = 'For the point '+lettersArray[i-5]+'(x, y) = (' + xArray[i - 4] + ',' + yArray[i - 4] + '):<br>'
                    + 'd<sub><sub>1</sub></sub> = Distance from (' + xArray[i - 4] + ',' + yArray[i - 4] + ') to Focus 1 = ' + dd1 + '<br>'
                    + 'd<sub><sub>2</sub></sub> = Distance from (' + xArray[i - 4] + ',' + yArray[i - 4] + ') to Focus 2 = ' + dd2 + '<br>'
                    + '|d<sub><sub>1</sub></sub> - d<sub><sub>2</sub></sub>| = |' + dd1 + ' - ' + dd2 + '| = <i>d</i> = ' + dd + '<br><br><br>'
                    ;
                document.getElementById('TableDataLimitY1C').innerHTML += text;
            }

            GraphingCalculator();
           
        }
        else if (parseFloat(Avalue) == parseFloat(Cvalue)) {//case 2:  hyperbola with branches up/down
            var cc2 = Math.abs(parseFloat(Bvalue) - parseFloat(Dvalue));
            if(cc2 > parseFloat(dd)){
                //alert('Input constant d must be greater than the distance between the two fixed points (foci).');
                //return;
            }
            ...
            //alert('aa2..' + aa2 + '.....bb2...' + bb2 );
            var hh = parseFloat(Avalue);
            var kk = (parseFloat(Bvalue) + parseFloat(Dvalue)) / 2;
            var ftn = 'hyperbolaYX('+hh+'; '+kk+'; '+aa2+'; '+bb2+')'
            document.getElementById('pointsonparabola').value = 'case2';
            document.getElementById('mydropdownCartesian1').value = 0;
            document.getElementById('TextBoxForCartesianGraph1').value = ftn;
            document.getElementById('Point3X').value = hh;//vertex 1
            document.getElementById('Point3Y').value = kk+aa;
            document.getElementById('Point4X').value = hh; //vertext 2
            document.getElementById('Point4Y').value = kk-aa;
            document.getElementById('Point17X').value = hh+bb; //M1
            document.getElementById('Point17Y').value = kk;
            document.getElementById('Point18X').value = hh-bb; //M2 
            document.getElementById('Point18Y').value = kk;
            document.getElementById('Point19X').value = hh;
            document.getElementById('Point19Y').value = kk;

            var ftn11 = '('+aa+')(1 + (x-' + '(' + hh + ')' + ')^2/'+bb2+')^(1/2) + ' + '('+kk+')';
            var ftn22 = '-('+aa+')(1+(x-' + '(' + hh + ')' + ')^2/'+bb2 +')^(1/2) + ' + '('+kk+')';
       ...
       //return;
            ...
            var stepsize = parseInt(cc) / 3;
            xArray[1] = hh -  1; yArray[1] = FindValue(ftn11.replace('x', '(' + xArray[1] + ')'));//alert(xArray[1]+'...1..'+yArray[1]);
            xArray[2] = hh -  1; yArray[2] = FindValue(ftn22.replace('x', '(' + xArray[2] + ')'));//alert(xArray[2]+'...2..'+yArray[2]);
            xArray[3] = hh -  3; yArray[3] = FindValue(ftn11.replace('x', '(' + xArray[3] + ')'));//alert(xArray[3]+'...3..'+yArray[3]);
            xArray[4] = hh -  3; yArray[4] = FindValue(ftn22.replace('x', '(' + xArray[4] + ')'));//alert(xArray[4]+'...4..'+yArray[4]);
            xArray[5] = hh -  5; yArray[5] = FindValue(ftn11.replace('x', '(' + xArray[5] + ')'));//alert(xArray[5]+'...5..'+yArray[5]);
            xArray[6] = hh -  5; yArray[6] = FindValue(ftn22.replace('x', '(' + xArray[6] + ')'));//alert(xArray[6]+'...6..'+yArray[6]);

            xArray[7] = hh +  5; yArray[7] = FindValue(ftn11.replace('x', '(' + xArray[7] + ')'));
            xArray[8] = hh +  5; yArray[8] = FindValue(ftn22.replace('x', '(' + xArray[8] + ')'));
            xArray[9] = hh +  3; yArray[9] = FindValue(ftn11.replace('x', '(' + xArray[9] + ')'));
            xArray[10] = hh + 3; yArray[10] = FindValue(ftn22.replace('x', '(' + xArray[10] + ')'));
            xArray[11] = hh + 1; yArray[11] = FindValue(ftn11.replace('x', '(' + xArray[11] + ')'));
            xArray[12] = hh + 1; yArray[12] = FindValue(ftn22.replace('x', '(' + xArray[12] + ')'));
            //xArray[13] = hh ; yArray[13] = FindValue(ftn.replace('x', '(' + xArray[13] + ')'));
            ...
            for (var i = 5; i <= 16; i++) {
                ...
                var xmy11 = parseFloat(xArray[i - 4]) - parseFloat(Avalue);
                var xmy22 = parseFloat(yArray[i - 4]) - parseFloat(Bvalue);
                var xmy33 = parseFloat(xArray[i - 4]) - parseFloat(Cvalue);
                var xmy44 = parseFloat(yArray[i - 4]) - parseFloat(Dvalue);

                var dd1 = Math.sqrt(xmy11*xmy11 + xmy22*xmy22);
                var dd2 = Math.sqrt(xmy33*xmy33 + xmy44*xmy44);

                //var dd1 = Math.sqrt(Math.pow(parseFloat(xArray[i - 4]) - parseFloat(Avalue), 2) + Math.pow(parseFloat(yArray[i - 4]) - parseFloat(Bvalue), 2));
                //var dd2 = Math.sqrt(Math.pow(parseFloat(xArray[i - 4]) - parseFloat(Cvalue), 2) + Math.pow(parseFloat(yArray[i - 4]) - parseFloat(Dvalue), 2));
                //alert('////' + xArray[i - 4] + '/////' + yArray[i - 4] + '////dd1 = ' + dd1 +  '////dd2 = ' + dd2 +'////diff = ' + (dd1 - dd2));
        ...
        if (document.getElementById('pointsonparabola').value == 'case1') {
            document.getElementById('TableDataLimitY1C').innerHTML += '<img src="hyperbolaDef2a.png" alt="blank" /><br><br>';
            //document.getElementById('TableDataLimitY1C').innerHTML += '<img src="hyperbola2b.png" alt="blank" />';
        }
        else if (document.getElementById('pointsonparabola').value == 'case2') {
            document.getElementById('TableDataLimitY1C').innerHTML += '<img src="hyperbolaDef2b.png" alt="blank" />';
        }
       return;
    ...
    function deltachange(casenum) {
        var PIsymbol = String.fromCharCode(960);   //PI
        var InputExpression = document.getElementById('LimitFunction3').value;
        var InputExpression2 = document.getElementById('LimitFunction4').value;

        document.getElementById('deltaXincrement').value = FindValue(ProcessInput(document.getElementById('deltaXincrement').value));
        document.getElementById('deltaXincrement2').value = FindValue(ProcessInput(document.getElementById('deltaXincrement2').value));
        document.getElementById('Avalue2').value = FindValue(ProcessInput(document.getElementById('Avalue2').value));
        document.getElementById('Bvalue2').value = FindValue(ProcessInput(document.getElementById('Bvalue2').value));
        var Avalue = document.getElementById('Avalue2').value;
        var Bvalue = document.getElementById('Bvalue2').value;

         if(parseFloat(Avalue) >= parseFloat(Bvalue)){
            var msg = 'Input for value of "a" must be less than input for value of "b".';
            alert(msg);
            return;
        }

        if (casenum == '1'){
            var stepsize = document.getElementById('deltaXincrement').value;
           var deltaX = parseFloat(Avalue) + parseFloat(stepsize);
            var  currentXvalue = parseFloat(deltaX);
            document.getElementById('Avalue2').value =  Math.round(deltaX * 10000000000) / 10000000000;
        }
        else if (casenum == '2'){
            var stepsize = document.getElementById('deltaXincrement').value;
            //stepsize = FindValue(ProcessInput(stepsize));
            var deltaX = parseFloat(Avalue) - parseFloat(stepsize);
            var  currentXvalue = parseFloat(deltaX);
            document.getElementById('Avalue2').value =  Math.round(deltaX * 10000000000) / 10000000000;
        }
        else if (casenum == '3'){
            var stepsize = document.getElementById('deltaXincrement2').value;
            //stepsize = FindValue(ProcessInput(stepsize));
            var deltaX = parseFloat(Bvalue) + parseFloat(stepsize);
            var  currentXvalue = parseFloat(deltaX);
            document.getElementById('Bvalue2').value =  Math.round(deltaX * 10000000000) / 10000000000;
        }
        else if (casenum == '4'){
            var stepsize = document.getElementById('deltaXincrement2').value;
            //stepsize = FindValue(ProcessInput(stepsize));
...
/**
        if (casenum == '1' ||casenum == '2'){
            ...
            var deltaX = parseFloat(Avalue) + parseFloat(stepsize);
            var  currentXvalue = parseFloat(deltaX);
            if (parseFloat(deltaX) < 0.0001) { deltaX = 0.001; }
            document.getElementById('Avalue2').value =  Math.round(deltaX * 1000000000000) / 1000000000000;
        }
        else{
            var stepsize = document.getElementById('deltaXincrement2').value;
            var deltaX = parseFloat(Bvalue) + parseFloat(stepsize);
            var  currentXvalue = parseFloat(deltaX);
            if (parseFloat(deltaX) < 0.0001) { deltaX = 0.001; }
            document.getElementById('Bvalue2').value =  Math.round(deltaX * 1000000000000) / 1000000000000;
        }

**/
        document.getElementById('TextBoxForCartesianGraph19').value = ''; 
        if (document.getElementById('showderivfnc').checked) {
            document.getElementById('TextBoxForCartesianGraph19').value = document.getElementById('LimitFunction4').value;//f'(x)
        }

        document.getElementById('TextBoxForCartesianGraph20').value = document.getElementById('LimitFunction3').value;//f(x)
        ...
        Avalue =  document.getElementById('Avalue2').value;// FindValue(ProcessInput(document.getElementById('Avalue2').value));
        Bvalue =  document.getElementById('Bvalue2').value;// FindValue(ProcessInput(document.getElementById('Bvalue2').value));

        //find f(a) and f(b)
        var fa = replaceAll(InputExpression, "x", "(" + Avalue.toString() + ")");
        var fb = replaceAll(InputExpression, "x", "(" + Bvalue.toString() + ")");
        fa = ProcessInput(fa.toString());
        fb = ProcessInput(fb.toString());
        fa = FindValue(fa.toString());
        fb = FindValue(fb.toString());
        fa = Math.round(fa * 10000000000) / 10000000000;
        fb = Math.round(fb * 10000000000) / 10000000000;
        var val1 = fa;
        var val2 = fb;

        if(parseFloat(fa) > parseFloat(fb)){
          val1 = fb;
          val2 = fa    
        }


        document.getElementById('TableDataLimitY1D').innerHTML = '<br>f(a) = f(' + Avalue + ') = ' + fa + '<br>';
        //document.getElementById('TableDataLimitY1D').innerHTML += ' L = ' + Lvalue + '<br><br>';
        document.getElementById('TableDataLimitY1D').innerHTML += 'f(b) = f(' + Bvalue + ') = ' + fb + '<br>';
   
        var slopesecantline = (fb - fa)/(Bvalue - Avalue);
        slopesecantline = Math.round(slopesecantline * 10000000000) / 10000000000;
        var text = 'Slope of secant line (aqua line) = [f(b) - f(a)]/[b - a] = ' + slopesecantline + '<br>';
                 //+ 'Slope of tangent line (at x = c) =  f'+" '"+'('+x+') = ' + slopesecantline + '<br>';   
        document.getElementById('TableDataLimitY1D').innerHTML += text;              

        //text = 'We want to find a number <i>c</i> such that '+ "f '"+'(c) = [f(b) - f(a)]/[b - a].<br>';
        //document.getElementById('TableDataLimitY1D').innerHTML += text;

        //text = 'Hence, we need to the solve equation ' + replaceAll(InputExpression2, "x", "(c)") + ' = ' + slopesecantline +' for c.<br><br>';
        //document.getElementById('TableDataLimitY1D').innerHTML += text;

        //text = 'Note: Depending of the type of equation, this equation may have more <br>than one solutions that lie in (a, b).<br><br>';
        //document.getElementById('TableDataLimitY1D').innerHTML += text;    
 
        
        var funcComb = InputExpression2 + '-('+slopesecantline+')';  
        var InputExpression3 = ProcessInput(funcComb);

        try {             
            var x = SolveEquation3(parseFloat(Avalue), parseFloat(Bvalue), InputExpression3) //Uses Newton-Raphson Method
            //var x = SolveEquationDirectTolerance(parseFloat(Avalue), parseFloat(Bvalue), InputExpression3, 8);
            if (IsNumericc(x) == false || x == null) {
                var x = SolveEquationDirectTolerance(parseFloat(Avalue), parseFloat(Bvalue), InputExpression3, 6);
            }
            if (IsNumericc(x) == false || x == null) {
                var x = SolveEquationDirectTolerance(parseFloat(Avalue), parseFloat(Bvalue), InputExpression3, 4);
            } 
            if (IsNumericc(x) == false || x == null) {
                var x = SolveEquationDirectTolerance(parseFloat(Avalue), parseFloat(Bvalue), InputExpression3, 2);
            } 
            if (IsNumericc(x) == false || x == null) {
                x = NaN;
                document.getElementById('TableDataLimitY1C').innerHTML += "Graphing Calculator could not find c such that:<br>"
                    +  "f '(c) = [f(b)-f(a)]/(b-a)";
                return;
            }
            //alert('777444...' + InputExpression2);
            x = Math.round(x * 100000000) / 100000000;

        } catch (err) {
                document.getElementById('TableDataLimitY1D').innerHTML += "Graphing Calculator could not find c such that:<br>"
                    +  "f '(c) = [f(b)-f(a)]/(b-a)";
        ...
        //var text = 'For the equation ' + InputExpression2 + ' = '+ slopesecantline + '<br>'
        // + 'one solution is ' + x +'.<br><br>';

        //document.getElementById('TableDataLimitY1D').innerHTML += text;
        


       if(x < Bvalue && x > Avalue ){
            text = 'Slope of tangent line (at x = c) =  f'+" '"+'('+x+') = ' + slopesecantline + '<br>';   
            document.getElementById('TableDataLimitY1D').innerHTML += text;              

            //text = 'Note that '+x+' lies in (a, b) = ('+Avalue + ' , ' + Bvalue + ') .<br><br>';
            //document.getElementById('TableDataLimitY1D').innerHTML += text;
            //document.getElementById('TableDataLimitY1D').innerHTML += 'Therfore, there exists c = ' +  x + '<br>'
            //             + " such that f '(c) = [f(b) - f(a)]/(b - a) <br><br>";

            //text = 'In summary:<br>'
            //     + 'c = ' + x + '<br>'
            //     + "f '(" + x + ') = ' + replaceAll(InputExpression2, "x", '(' + x + ')') + ' = ' + slopesecantline + '<br>'
            //     + '[f(b) - f(a)]/(b - a) = ' + slopesecantline;
            //document.getElementById('TableDataLimitY1D').innerHTML += text;
       }
       else{
           text = 'Note that ' + x + ' is not in [a, b].<br><br>';
           document.getElementById('TableDataLimitY1D').innerHTML += text;
           return;
       }
        ...
        //(a, 0)
        document.getElementById('Point14X').value = Avalue;
        document.getElementById('Point14Y').value = 0; 
        //(b, 0)
        document.getElementById('Point15X').value = Bvalue;
        document.getElementById('Point15Y').value = 0; 
        //(c, 0)
        document.getElementById('Point16X').value = x;
        document.getElementById('Point16Y').value = 0; 
        //(a, f(a))
        document.getElementById('Point17X').value = Avalue;
        document.getElementById('Point17Y').value = fa;
        //(b, f(b))
        document.getElementById('Point18X').value = Bvalue;
        document.getElementById('Point18Y').value = fb;
        ...
        //(c, f(c))
        document.getElementById('Point13X').value = x;
        document.getElementById('Point13Y').value = y1; 


        //document.getElementById('TextBoxForCartesianGraph18').value = '('+fa+')';
        //document.getElementById('TextBoxForCartesianGraph19').value = '('+y1+')';

        var equationsecantline = slopesecantline + '(x - (' + Avalue + ')) + (' + fa +')';
        var equationtangentline = slopesecantline + '(x - (' + x + ')) + (' + y1 +')';
        //document.getElementById('TextBoxForCartesianGraph18').value = equationsecantline;
        //document.getElementById('TextBoxForCartesianGraph19').value = equationtangentline;


        var xtt1 = FindValue(document.getElementById('xMinParameter').value);
        var xtt2 = FindValue(document.getElementById('xMaxParameter').value);
        //var yRmin = FindValue(document.getElementById('yMinParameter').value);
        //var yRmax = FindValue(document.getElementById('yMaxParameter').value);

        //data for tangent line
        var temp1 = replaceAll(equationtangentline, "x", "(" + xtt1.toString() + ")");
        var ytt1 = FindValue(temp1);
        var temp2 = replaceAll(equationtangentline, "x", "(" + xtt2.toString() + ")");
        var ytt2 = FindValue(temp2);
        document.getElementById('tangentlinedata').value = xtt1 + ';' + xtt2 + ';;;' + ytt1 + ';' + ytt2;

        //data for secant line
        var temp1 = replaceAll(equationsecantline, "x", "(" + xtt1.toString() + ")");
        var ytt1 = FindValue(temp1);
        var temp2 = replaceAll(equationsecantline, "x", "(" + xtt2.toString() + ")");
        var ytt2 = FindValue(temp2);
        document.getElementById('secantlinedata').value =  xtt1 + ';' + xtt2 + ';;;' + ytt1 + ';' + ytt2;
        //alert("solx = " + document.getElementById('secantlinedata').value);
        GraphingCalculator();
    ...
    function GraphEpsDel() {
        ...
        document.getElementById('TableDataLimitY1D').innerHTML = "<br><br> Note: When x = " + XH + " , &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; y = f("+XH + ") =  " + y + "<br><br>";
    ...
    function tableCreateLimit(xdata, ydata,zdata,color,TableName,RightSideEquation,Avalue,Bvalue) {        
        ...
        td.style.color = color;
        td.style.borderColor = color;
        td.appendChild(document.createTextNode('c ∈ [a , b]=['+Avalue+' , '+Bvalue+'] ?'));
        ...
        for (var i = 0; i < xval.length; i++) {
            ...
            td.style.color = "black";
            td.style.borderWidth = '1px';
            td.appendChild(document.createTextNode(zval[i]));
...
*----------------------------------------------------------------------------*/   
    function handleEventKeyboard(e, num) {
        ...
        if (num == '1') {
            ...
            document.getElementById('panel2').style.left = '620px';
        }
        else if (num == '2') {
            document.getElementById('panel2').style.display = 'inline-block';
            document.getElementById('panel2').style.top = parseInt(clickY) + 'px';
            document.getElementById('panel2').style.left = '1300px';
        }
    }
