...
function insertAtCaret(element, text, val1, val2, val3, val4) {
   ...
   function Textboxongrid22BB(casenum) {
    ...
    function xplusc(){
        document.getElementById('deltaX2').value = parseFloat(document.getElementById('limitvalue').value) + 3;
    }
    ...
    function deltachange(casenum) {
        ...
        var deltaX = document.getElementById('deltaX').value;//initial x value
        var  currentXvalue = parseFloat(Cvalue) + parseFloat(deltaX);//current x value
        if (casenum == '1') {
        ...
        //deltaX = location of x
        document.getElementById('Point20X').value = currentXvalue;
        ...
        //(x, f(x)
        var x2 =  currentXvalue;//document.getElementById('deltaX').value;
        ...
        //location of (x, f(c))
        document.getElementById('Point16X').value = currentXvalue;
        document.getElementById('Point16Y').value = y1;

        //location of delta x-c
        document.getElementById('Point15X').value = (parseFloat(currentXvalue) + parseFloat(Cvalue))/2;
        document.getElementById('Point15Y').value = y1;

        //location of f(x)-f(c)
        document.getElementById('Point14X').value = currentXvalue;
        document.getElementById('Point14Y').value = (parseFloat(y2) + parseFloat(y1))/2;


        //(x3, f(x3))  for tangent line
        var x3 = parseFloat(Cvalue) + 0.001;
        ...
        currentXvalue = Math.round(currentXvalue * 10000000000) / 10000000000;
        dy = Math.round(dy * 10000000000) / 10000000000;
        slopesecantline = Math.round(slopesecantline * 10000000000) / 10000000000;
        document.getElementById('TableDataLimitY1D').innerHTML = 'c = ' +Cvalue + '<br>';
        var xminusc = Math.round((currentXvalue-Cvalue) * 10000000000) / 10000000000;
        document.getElementById('TableDataLimitY1D').innerHTML += 'x-c = ' +xminusc + '<br>';
        document.getElementById('TableDataLimitY1D').innerHTML += 'f(x) = '+ y2+ '<br>';
        document.getElementById('TableDataLimitY1D').innerHTML += 'f(c) =' + y1+ '<br>';
        var fxminusfc =  Math.round((y2-y1) * 10000000000) / 10000000000;
        document.getElementById('TableDataLimitY1D').innerHTML += 'f(x) - f(c) = '+ fxminusfc + '<br>';
        var text = 'Slope of secant line = [f(x)-f(c)]/(x-c) = ' + slopesecantline;
    ...
    function findtangentline() {
        ...
        document.getElementById('leftsidelimit').innerHTML = 'Limit from the left: x approaches c = '+ Cvalue + ' from the left.';
        document.getElementById('rightsidelimit').innerHTML = 'Limit from the right: x approaches c = '+ Cvalue + ' from the right.';


        var deltasymbol = String.fromCharCode(916);
        var deltaXsymbol = String.fromCharCode(916)+'x';
        var deltaYsymbol = String.fromCharCode(916)+'y';
        var diffquot = '[f(x)-f(c)]/(x-c)';
        ...
        var text22 = 'x = '+deltaX + '(arbitrary value of x near c)<br>';
        var text22 =text22+ 'c+x = '+CplusDeltaX+'<br>';
        document.getElementById('TableDataLimitY1C').innerHTML += text22;
        var text22 = 'f(c+x) = '+y2+'<br>';
        document.getElementById('TableDataLimitY1C').innerHTML += text22;
        var text22 = 'f(x) - f(c) = '+(y2-y1)+'<br>';
        document.getElementById('TableDataLimitY1C').innerHTML += text22;
        var text22 = 'Slope of Secant Line = (f(x) - f(c))/(x-c)= '+((y2-y1)/parseFloat(deltaX))+'<br><br>';
        document.getElementById('TableDataLimitY1C').innerHTML += text22;

        var text22 = 'Slope of tangent line depends on the <br>limit of [f(x)-f(c)]/(x-c) as x approaches c.<br><br>';
        document.getElementById('TableDataLimitY1C').innerHTML += text22;


        var text11 = 'In the tables below, the ' + diffquot + ' <br>column represents the '
           + 'slope of the secant line (aqua line on grid).<br>'
           + 'To see if the limit of ' + diffquot + ' exists as x approaches c, <br>'
           + 'we can examine the values in last column of each table. <br>'
           + 'If the limit of ' + diffquot + ' exists as x approaches c <br>'
        ...
        if (parseFloat(limval) == 0) {            
            ...
            for (var i = 1; i <= 11; i++) {
                ...
                if (isFinite(fx) == false) {
                    fx = 'Very Large Number';
                }

                var dx = parseFloat(x) - parseFloat(Cvalue);
                var dy = parseFloat(fx) - parseFloat(fc);
    ...
    function tableCreateLimit(data1, data2, data3, data4, data5,color,TableName,RightSideEquation,fc) {        
        ...
        var val1 = data1.split(';'); //x
        var val2 = data2.split(';'); //x-c
        var val3 = data3.split(';'); //fx
        var val4 = data4.split(';'); //f(x)-f(c)
        var val5 = data5.split(';'); //dy/dx
        ...
        td.style.color = color;
        td.style.borderColor = color;
        td.appendChild(document.createTextNode('x-c'));
        ...
        td.style.color = color;
        td.style.borderColor = color;
        td.appendChild(document.createTextNode('f(x)-f(c)'));
        ...
        td.style.color = color;
        td.style.borderColor = color;
        td.appendChild(document.createTextNode('[f(x)-f(c)]/(x-c)'));
        ...
        for (var i = 0; i < val1.length; i++) {
            ...
            td.appendChild(document.createTextNode(val1[i]));
            ...
            td.style.color = "black";
            td.style.borderWidth = '1px';
            td.appendChild(document.createTextNode(val2[i]));
            ...
            td.style.color = "black";
            td.style.borderWidth = '1px';
            td.appendChild(document.createTextNode(val3[i]));
            ...
            td.style.color = "black";
            td.style.borderWidth = '1px';
            td.appendChild(document.createTextNode(val4[i]));
            ...
            td.style.color = "black";
            td.style.borderWidth = '1px';
            td.appendChild(document.createTextNode(val5[i]));
        }
