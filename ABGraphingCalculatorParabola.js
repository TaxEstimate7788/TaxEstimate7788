        ...
        for (var i = 1; i <= 20; i++) {
         ...
         if (document.getElementById('segmentsOnGraph').checked) {
             ...
             for (var i = 2; i <= NN+1; i++) {
                 ...
                 //alert(dataX +'....'+ dataY);
                 if ((IsNumericc(FocusX) == false) || (IsNumericc(FocusY) == false) || (IsNumericc(xtt) == false) || (IsNumericc(ytt) == false)) {
                     //do nothing
                 }
                 else {
            ...
            var myVarClear = setInterval(function () {
                //alert('i = ' + ii);
                ii = ii + 1; ctx.globalAlpha = 1;
                var xtt = document.getElementById('Point' + ii + 'X').value;
                var ytt = document.getElementById('Point' + ii + 'Y').value;
                var dataX = [FocusX, xtt];
                var dataY = [FocusY, ytt];
                funGraph(ctx, "LIMIT", 'green', 3, dataX, dataY, xRminn, xRmaxx, yRminn, yRmaxx, x0, y0, dxx, dyy, dashFlag, ShadeFlag, '0.3');
                ...
                var cc1 = parseFloat(FocusX) - parseFloat(xtt);
                var cc2 = cc1 * cc1;
                var bb1 = parseFloat(FocusY) - parseFloat(ytt);
                var bb2 = bb1 * bb1;
                var dist = Math.sqrt(cc2 + bb2);
                document.getElementById('LengthOfSegment').innerHTML = 'length of segment = ' + dist;
                ...
                for (var i = 1; i <= 20; i++) {
                    ...
                    if (coordX != "" && coordY != "" && PlotStatus) {
                        ...
                        if(document.getElementById('labelpoints').checked){
                            ...
                            if(i>= 2){
                                var Label = lettersArray[i-2] + '(' + coordX + ' , ' + coordY + ')';
                            }
                        }
                        else{
                            var Label = '';
                        ...
                        if (OpenClose) {
                            ...
                            if (i == 1) {
                                ...
                                ctx.font="20px Georgia";
                                Label = ''
                                ctx.fillText(Label, xcoord - 40, ycoord + 5);
                                ctx.stroke();
                                ctx.closePath();
...
///////////////////  SHADING  //////////////////////////////
   ...
   function findIVT() {
        ...
        Avalue =   FindValue(ProcessInput(Avalue.toString()));
        Bvalue =   FindValue(ProcessInput(Bvalue.toString()));
        ...
        var tt2 = tt.split('=');
        if (tt.indexOf('y') > -1) {//case 1:  directrix is horizontal (y = c) and focus is above
            ...
            var pp = (parseFloat(Bvalue) - dd) / 2;
            pp = Math.abs(pp);
            var kk = (parseFloat(Bvalue) + dd) / 2;
            var hh = parseFloat(Avalue)

            if (parseFloat(Bvalue) > parseFloat(FindValue(tt2[1]))) {
                //alert('case 1');
                var ftn = '(1/(4*' + pp + '))(x -' + '(' + hh + '))^2+(' + kk+')';
            ...
            document.getElementById('mydropdownCartesian2').value = 0;
            document.getElementById('TextBoxForCartesianGraph2').value = ftn;


            var xArray = [];
            var yArray = [];

            xArray[1] = hh - 10; yArray[1] = FindValue(ftn.replace('x', '(' + xArray[1] + ')'));
            xArray[2] = hh - 8; yArray[2] = FindValue(ftn.replace('x', '(' + xArray[2] + ')'));
            xArray[3] = hh - 6; yArray[3] = FindValue(ftn.replace('x', '(' + xArray[3] + ')'));
            xArray[4] = hh - 4; yArray[4] = FindValue(ftn.replace('x', '(' + xArray[4] + ')'));
            xArray[5] = hh - 2; yArray[5] = FindValue(ftn.replace('x', '(' + xArray[5] + ')'));
            xArray[6] = hh - 1; yArray[6] = FindValue(ftn.replace('x', '(' + xArray[6] + ')'));

            xArray[7] = hh + 1; yArray[7] = FindValue(ftn.replace('x', '(' + xArray[7] + ')'));
            xArray[8] = hh + 2; yArray[8] = FindValue(ftn.replace('x', '(' + xArray[8] + ')'));
            xArray[9] = hh + 4; yArray[9] = FindValue(ftn.replace('x', '(' + xArray[9] + ')'));
            xArray[10] = hh + 6; yArray[10] = FindValue(ftn.replace('x', '(' + xArray[10] + ')'));
            xArray[11] = hh + 8; yArray[11] = FindValue(ftn.replace('x', '(' + xArray[11] + ')'));
            xArray[12] = hh + 10; yArray[12] = FindValue(ftn.replace('x', '(' + xArray[12] + ')'));
            xArray[13] = hh ; yArray[13] = FindValue(ftn.replace('x', '(' + xArray[13] + ')'));

            document.getElementById('TableDataLimitY1C').innerHTML = '';

            for (var i = 2; i <= 14; i++) {
                document.getElementById('Point'+i+'X').value =  xArray[i-1];
                document.getElementById('Point'+i+'Y').value = yArray[i-1];


                var text = 'For the point '+lettersArray[i-2]+'(x, y) = (' + xArray[i - 1] + ',' + yArray[i - 1] + '):<br>'
                    + 'Distance from (' + xArray[i - 1] + ',' + yArray[i - 1] + ') to directrix = ' + Math.abs(parseFloat(yArray[i - 1]) - dd) + '<br>'
                    + 'Distance from (' + xArray[i - 1] + ',' + yArray[i - 1] + ') to Focus = ' + Math.abs(parseFloat(yArray[i - 1]) - dd) + '<br><br><br>'
                    ;
        ...
        else if (tt.indexOf('x') > -1 ) {//case 3:  directrix is vertical (x = c) and focus is right
            document.getElementById('mydropdownCartesian1').value = 5;
            document.getElementById('TextBoxForCartesianGraph1').value = tt2[1];


            var dd = parseFloat(FindValue(tt2[1]));
            var pp = (parseFloat(Avalue) - dd) / 2;
            pp = Math.abs(pp);
            var hh = (parseFloat(Avalue) + dd) / 2;
            var kk = parseFloat(Bvalue)

            if (parseFloat(Avalue) > parseFloat(FindValue(tt2[1]))) {
                var ftn = '(1/(4*' + pp + '))(y -' + '(' + kk + '))^2+(' + hh+')';            
                document.getElementById('pointsonparabola').value = 'case3';
            }

            if (parseFloat(Avalue) < parseFloat(FindValue(tt2[1]))) {
                var ftn = '(-1/(4*' + pp + '))(y -' + '(' + kk + '))^2+(' + hh+')';
                document.getElementById('pointsonparabola').value = 'case4';
            }
            ...
            //alert('ftn = ' + ftn);
            yArray[1] = kk - 10; xArray[1] = FindValue(ftn.replace('y', '(' + yArray[1] + ')'));
            yArray[2] = kk - 8; xArray[2] = FindValue(ftn.replace('y', '(' + yArray[2] + ')'));
            yArray[3] = kk - 6; xArray[3] = FindValue(ftn.replace('y', '(' + yArray[3] + ')'));
            yArray[4] = kk - 4; xArray[4] = FindValue(ftn.replace('y', '(' + yArray[4] + ')'));
            yArray[5] = kk - 2; xArray[5] = FindValue(ftn.replace('y', '(' + yArray[5] + ')'));
            yArray[6] = kk - 1; xArray[6] = FindValue(ftn.replace('y', '(' + yArray[6] + ')'));

            yArray[7] = kk + 1; xArray[7] = FindValue(ftn.replace('y', '(' + yArray[7] + ')'));
            yArray[8] = kk + 2; xArray[8] = FindValue(ftn.replace('y', '(' + yArray[8] + ')'));
            yArray[9] = kk + 4; xArray[9] = FindValue(ftn.replace('y', '(' + yArray[9] + ')'));
            yArray[10] = kk + 6; xArray[10] = FindValue(ftn.replace('y', '(' + yArray[10] + ')'));
            yArray[11] = kk + 8; xArray[11] = FindValue(ftn.replace('y', '(' + yArray[11] + ')'));
            yArray[12] = kk + 10; xArray[12] = FindValue(ftn.replace('y', '(' + yArray[12] + ')'));
            yArray[13] = kk ; xArray[13] = FindValue(ftn.replace('y', '(' + yArray[13] + ')'));
            ...
            for (var i = 2; i <= 14; i++) {
                ...
                var text = 'For the point '+lettersArray[i-2]+'(x, y) = (' + xArray[i - 1] + ',' + yArray[i - 1] + '):<br>'
                    + 'Distance from (' + xArray[i - 1] + ',' + yArray[i - 1] + ') to directrix = ' + Math.abs(parseFloat(xArray[i - 1]) - dd) + '<br>'
                    + 'Distance from (' + xArray[i - 1] + ',' + yArray[i - 1] + ') to Focus = ' + Math.abs(parseFloat(xArray[i - 1]) - dd) + '<br><br><br>'
                    ;
                document.getElementById('TableDataLimitY1C').innerHTML += text;
            }
        ...
        if (document.getElementById('pointsonparabola').value == 'case1') {
            document.getElementById('TableDataLimitY1C').innerHTML += '<img src="parabola2.png" alt="blank" /><br><br>';
            document.getElementById('TableDataLimitY1C').innerHTML += '<img src="parabola2b.png" alt="blank" />';
        }
        else if (document.getElementById('pointsonparabola').value == 'case2') {
            document.getElementById('TableDataLimitY1C').innerHTML += '<img src="parabola2c.png" alt="blank" />';
        }
        else if (document.getElementById('pointsonparabola').value == 'case3') {
            document.getElementById('TableDataLimitY1C').innerHTML += '<img src="parabola2d.png" alt="blank" />';
        }
        else if (document.getElementById('pointsonparabola').value == 'case4') {
            document.getElementById('TableDataLimitY1C').innerHTML += '<img src="parabola2e.png" alt="blank" />';
        }
...
function insertAtCaret(element, text, val1, val2, val3, val4) {
   ...
   function Textboxongrid22BB(casenum) {
    ...
    function Example1ivt(){
        document.getElementById('LimitFunction').value = 'y = -2';
        document.getElementById('LimitFunction2').value = 'x +2';
    ...
    function Example2ivt(){
        document.getElementById('LimitFunction').value = 'y = 4';
        document.getElementById('LimitFunction2').value = 'x +2';
        document.getElementById('Avalue').value = '0';
        document.getElementById('Bvalue').value = '2';
        document.getElementById('NumberOfSegments').value = '0';
     ...
     function Example4ivt(){
        document.getElementById('LimitFunction').value = 'x = 4';
        document.getElementById('LimitFunction2').value = 'x +2';
        document.getElementById('Avalue').value = '0';
        document.getElementById('Bvalue').value = '2';
        document.getElementById('NumberOfSegments').value = '0';
     ...
     function Example5ivt(){
        document.getElementById('LimitFunction').value = 'x = -8';
        document.getElementById('LimitFunction2').value = 'x +2';
        document.getElementById('Avalue').value = '0';
        document.getElementById('Bvalue').value = '2';
